<%@ Page Title="Letras - Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="LetrasVentas.aspx.cs" Inherits="SistemaInventario.CuentasPorCobrar.LetrasVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="LetrasVentas.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <td>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="chkRenovacion" runat="server" Text="Renovar" Checked="false" Font-Bold="True" />
                                        </td>
             ...
             <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtAvalPermanente" runat="server" Width="220px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" ReadOnly="False" Text=""></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold; padding-left: 8PX;">
                                            Domicilio
                                        </td>
                                        <td style="padding-left: 4PX;">
                                            <asp:TextBox ID="txtDomicilio" runat="server" Width="426px" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtLocalidad" runat="server" Width="220px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtTelefono" runat="server" Width="175px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ReadOnly="False" Text=""></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold; padding-left: 8PX;">
                                            D.O.I. / RUC
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDOIRUC" runat="server" Width="175px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ReadOnly="False" Text=""></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <td>
                                    ...
                                    <td style="padding-left: 120PX;font-weight: bold">
                                        total letra
                                    </td>
                                    <td>
                        ...
                        <td align="right">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTotalFactura" runat="server" Width="120px" Font-Names="Arial" ForeColor="Blue"
                                            Font-Bold="True" CssClass="Derecha" ReadOnly="True" Text="0.00"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>   
                        ...
                        <td style="padding-top: 5px;" valign="top">
                            ...
                            <div id="div_grvLetra" style="padding-top: 1px;">
                                <asp:GridView ID="grvLetra" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <HeaderTemplate>
                                                                <asp:CheckBox ID="checkAll" runat="server" onclick="checkAllLetras(this);" />
                                                            </HeaderTemplate>
                                        <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Numero" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox runat="server" ID="txtLetra" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo" class="detallesart" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Letra") %>'
                                                    onblur="F_ActualizarLetra(this.id,1); return false;" ReadOnly="True"></asp:TextBox>
                            ...
                            <div id="div_grvFactura" style="padding-top: 1px;">
                                <asp:GridView ID="grvFactura" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                         <HeaderTemplate>
                                                                <asp:CheckBox ID="checkAll" runat="server" onclick="checkAllFactura(this);" />
                                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="chkEliminar" CssClass="chkDelete" Text="" />
                                        ...
                                        <%--<asp:TemplateField HeaderText="ID">
                                            <ItemStyle HorizontalAlign="Right" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblID" Text='<%# Bind("Detalle") %>' CssClass="detallesart"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
            ...
            <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                        <tr>
                           <td>
                                <asp:CheckBox ID="CheckBox1" runat="server" Text="Numero" Font-Bold="True" />
                            </td>
                                        <td>
                                        <table cellpadding="0" cellspacing="0">
                                        <tr>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEliminarDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR LETRA" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgImprimir" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="IMPRIMIR LETRA" OnClientClick="F_Imprimir(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="R">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPDF" ImageUrl="~/Asset/images/pdf.png" ToolTip="GENERAR PDF"
                                    OnClientClick="F_ImprimirDocumentos(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPDFLetra" ImageUrl="~/Asset/images/pdf.png" ToolTip="GENERAR PDF LETRA"
                                    OnClientClick="F_ImprimirDocumentosLetra(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Vcto">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblVcto" Text='<%# Bind("Vcto") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:GridView ID="grvEliminado" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RazonSocial">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblcliente" Text='<%# Bind("RazonSocial") %>' CssClass="detallesart"></asp:Label>
                                <asp:HiddenField ID="hfCodBanco" runat="server" Value='<%# Bind("CodBanco") %>' />
                                <asp:HiddenField ID="hfCodigo" runat="server" Value='<%# Bind("Codigo") %>' />
                        ...
                        <div id="div_grvConsultaFactura">
                            <asp:GridView ID="grvConsultaFactura" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <HeaderTemplate>
                                                                <asp:CheckBox ID="checkAll" runat="server" onclick="checkAllOK(this);" />
                                                            </HeaderTemplate>
                                        <ItemTemplate>
    ...
    <div id="div_DatosLetra" style="display: none;">
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                    <td colspan="4">
                        <asp:Button ID="btnGrabarLetra" runat="server" Text="CANJEAR" Width="120px" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                            Font-Names="Arial" Font-Bold="True" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTotalFacturaLetra" runat="server" Width="75px" Font-Names="Arial"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNroLetra" runat="server" Width="55px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                    <td style="font-weight: bold">
                        CANT. LETRA
                    ...
                    <td>
                        <asp:TextBox ID="txtCantidadLetra" runat="server" Width="75px" Font-Names="Arial"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPrimerVencimiento" runat="server" Width="55px" Font-Names="Arial"
                            CssClass="Jq-ui-dtp" ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td style="font-weight: bold">
                        Intervalo
                    </td>
                    <td>
                        <asp:TextBox ID="txtIntervalo" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtVencimiento1" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento6" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento11" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento16" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtVencimiento2" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento7" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento12" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento17" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtVencimiento3" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento8" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento13" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento18" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtVencimiento4" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento9" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento14" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento19" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtVencimiento5" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento10" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento15" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVencimiento20" runat="server" Width="75px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display: none;">
