<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMercedes.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMercedes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMercedes.js" charset="UTF-8"></script>
                                      ...
                                      <tr>
                                       <td style="font-weight: bold; padding-left: 5px">
                                        ...
                                        <td style="padding-left: 26px">
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="676px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td>
                                         <asp:Label ID="lblDetraRete" runat="server" Text="ObsDetraRete" Font-Bold="True"></asp:Label>
                                        </td>
                                      </tr>
                                      </table>
                                      </td>
        ...
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <tr>
              <td style="font-weight: bold" colspan='2' align="center">
                        <asp:Label ID="Label5" runat="server" Text="NO MODIFICA LAS COBRANZAS" Font-Bold="True" Font-Size="Large"></asp:Label>
                    </td>
            </tr>
                <tr>
                    <td style="font-weight: bold">
