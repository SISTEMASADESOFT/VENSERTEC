var AppSession = "../Ventas/RegistroFacturaMercedes.aspx";
...
$(document).ready(function () {
        ...
        $('#MainContent_txtNroRucTransportistaEdicion').autocomplete(   
    {
        ...
        complete: function () {
            $('#MainContent_txtNroRucTransportistaEdicion').val($('#hfNroRucTransportista').val());
  ...
  $('#MainContent_txtConductorDNI').autocomplete({
        source: function (request, response) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                url: '../Servicios/Servicios.asmx/F_ListarClientes_AutoComplete',
                data: "{'NroRuc':'" + "" + "','RazonSocial':'" + request.term + "','CodTipoCtaCte':'" + 5 + "','CodTipoCliente':'" + 0 + "'}",
                dataType: "json",
                async: true,
                success: function (data) {
                    response($.map(data.d, function (item) {
        ...
        select: function (e, i) {
            ...
            $('#hfDniConductor').val(i.item.label);
...
//            $('#MainContent_txtTransportista').val(i.item.label);
//            $('#MainContent_txtNroRucTransportista').val(i.item.NroRuc);
//            $('#MainContent_txtDireccionTransportista').val(i.item.Direccion +' - ' +i.item.Distrito );
//            $('#hfDireccionTransportista').val(i.item.Direccion);
//            $('#hfCodDireccionTransportista').val(i.item.CodDireccion);
//            $('#hfCodDireccionDefecto').val(i.item.CodDireccion);
//            $('#MainContent_txtDistritoTransportista').val(i.item.Direccion+' - ' +i.item.Distrito);
//            $('#hfCodDepartamentoTransportista').val(i.item.CodDepartamento);
//            $('#hfCodProvinciaTransportista').val(i.item.CodProvincia);
//            $('#hfCodDistritoTransportista').val(i.item.CodDistrito);
//            $('#hfDistritoTransportista').val(i.item.Distrito.trim());
    ...
    $("#MainContent_chkGuiaEdicion").click(function () {
        if ($(this).is(':checked')) {
            ...
            $('#MainContent_txtPesoEdicion').val('');
                  ...
                  $('#MainContent_txtPlacaTrasladoEdicion').prop('readonly', true);
                  $('#MainContent_txtMarcaGuiaEdicion').prop('readonly', true);
                  $('#MainContent_txtLicenciaGuiaEdicion').prop('readonly', true);
                  $('#MainContent_txtConductorDNIEdicion').prop('readonly', true);
                  $('#MainContent_txtConductorRazonSocialEdicion').prop('readonly', true);
        }
    });
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_igv', result.split('~')[8]);
                        $('#MainContent_ddlMoneda').val(1);
                        $('#hfComisionTarjeta').val( result.split('~')[36]);
                        $('#MainContent_lblCT').text("TOTAL TARJETA (+"+result.split('~')[36]+"%)");
            ...
            success: function (dbObject) {
                ...
                $('#td_loadingTransportista').css('display', 'none');
                  ...
                  //  $('#hfUbigeo').val(dbObject.ubigeo);
                   ...
                   F_BuscarDireccionNuevoTransportista();
                }
                catch (x) { }
                MostrarEspera(false);
            },
...
//                                cadena=cadena + "\n" + "No tiene stock para el Codigo " + lblcodproducto_grilla; 
                                    ...
                                    if (parseFloat(txtcantidad_grilla) > parseFloat(lblStock_grilla) & $('#hfCodTipoProducto').val() == 2)
        ...
        if ($('#MainContent_chkNotaPedido').is(':checked'))
            chkNotaPedido = 1;
                ...
                if (str_resultado_operacion == "1") 
                {
                    ...
                    $('#hfComisionTarjeta').val(result.split('~')[10]);
                    if ( $('#MainContent_ddlFormaPago').val()==15){
                    $('#MainContent_txtComisionTarjeta').val(result.split('~')[9]);
                    }
...
//           if  ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_txtNuBultosEdicion').val() == 0 &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')
//            Cadena=Cadena + '<p></p>' + 'BULTOS';
...
//        if     ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_txtPesoEdicion').val() == 0 &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')
//            Cadena=Cadena + '<p></p>' + 'PESO';

//                  if     ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_ddlTipoDoc').val() == 16 &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')
//            Cadena=Cadena + '<p></p>' + 'LA PROFORMA NO PUEDE TENER GUIA ELECTRONICA'; 
    ...
    if   ($('#MainContent_chkGuia').prop('checked') && $('#MainContent_ddlTipoDoc').val() == 16 &&  $("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T')
         ...
         if    (($('#MainContent_chkGuia').prop('checked') && $('#MainContent_txtPeso').val().trim() == "" &&  $("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T' ) | ($('#MainContent_chkGuia').prop('checked') && $('#MainContent_txtPeso').val() == 0 &&  $("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T'))
            Cadena=Cadena + '<p></p>' + 'PESO';
//                 
                 if (( $(Cuerpo + 'txtPlaca').val()+ $(Cuerpo + 'txtPlaca2').val() +$(Cuerpo + 'txtPlaca3').val()+ $(Cuerpo + 'txtPlaca4').val()+ $(Cuerpo + 'txtPlaca5').val()
                         + $(Cuerpo + 'txtPlaca6').val()+ $(Cuerpo + 'txtPlaca7').val()+ $(Cuerpo + 'txtPlaca8').val())!='')
                                {
                         if((($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca2').val()) || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca3').val())
                         || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca4').val()) || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca5').val())
                         || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca6').val()) || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca7').val())
                         || ($(Cuerpo + 'txtPlaca').val()==$(Cuerpo + 'txtPlaca8').val()) || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca3').val())
                         || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca4').val()) || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca5').val())
                         || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca6').val()) || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca7').val())
                         || ($(Cuerpo + 'txtPlaca2').val()==$(Cuerpo + 'txtPlaca8').val()) || ($(Cuerpo + 'txtPlaca3').val()==$(Cuerpo + 'txtPlaca4').val())
                         || ($(Cuerpo + 'txtPlaca3').val()==$(Cuerpo + 'txtPlaca5').val()) || ($(Cuerpo + 'txtPlaca3').val()==$(Cuerpo + 'txtPlaca6').val())
                         || ($(Cuerpo + 'txtPlaca3').val()==$(Cuerpo + 'txtPlaca7').val()) || ($(Cuerpo + 'txtPlaca3').val()==$(Cuerpo + 'txtPlaca8').val())
                         || ($(Cuerpo + 'txtPlaca4').val()==$(Cuerpo + 'txtPlaca5').val()) || ($(Cuerpo + 'txtPlaca4').val()==$(Cuerpo + 'txtPlaca6').val())
                         || ($(Cuerpo + 'txtPlaca4').val()==$(Cuerpo + 'txtPlaca7').val()) || ($(Cuerpo + 'txtPlaca4').val()==$(Cuerpo + 'txtPlaca8').val())
                         || ($(Cuerpo + 'txtPlaca5').val()==$(Cuerpo + 'txtPlaca6').val()) || ($(Cuerpo + 'txtPlaca5').val()==$(Cuerpo + 'txtPlaca7').val()) 
                         || ($(Cuerpo + 'txtPlaca5').val()==$(Cuerpo + 'txtPlaca8').val()) || ($(Cuerpo + 'txtPlaca6').val()==$(Cuerpo + 'txtPlaca7').val())
                         || ($(Cuerpo + 'txtPlaca6').val()==$(Cuerpo + 'txtPlaca8').val()) || ($(Cuerpo + 'txtPlaca7').val()==$(Cuerpo + 'txtPlaca8').val())) && ($(Cuerpo + 'txtPlaca').val()!=''&& $(Cuerpo + 'txtPlaca2').val()!=''
                         && $(Cuerpo + 'txtPlaca3').val()!=''&& $(Cuerpo + 'txtPlaca4').val()!=''&& $(Cuerpo + 'txtPlaca5').val()!=''&& $(Cuerpo + 'txtPlaca6').val()!=''
                         && $(Cuerpo + 'txtPlaca7').val()!=''&& $(Cuerpo + 'txtPlaca8').val()!=''))
                        {
            ...
            if (Email1 === "SIN CORREOS")
                Email1 = "";
                   ...
                   var objParams = {
                                        ...
                                        Filtro_Igv: $(Contenedor + 'txtIgv').val(),
                                        Filtro_Total: $(Contenedor + 'txtTotal').val(),
                                        Filtro_TotalTarjeta: $(Contenedor + 'txtComisionTarjeta').val(),
...
function F_AnularRegistro() {
 ...
 try 
    ...
    var objParams = {
                          ...
                          Filtro_Hasta: $('#MainContent_txtHasta').val(),
                          Filtro_CodCtaCte: $('#hfCodCtaCteConsulta').val(),
                          Filtro_CodTipoDoc: $('#hfCodTipoDocAnulacion').val(),
                          Filtro_ChkNumero: chkNumero,
                          Filtro_ChkFecha: chkFecha,
                          Filtro_ChkCliente: chkCliente,
...
function F_EditarRegistro(Fila) {
 ...
 try 
    ...
    F_DatosFactura_NET(arg, function (result) {
            ...
            $('#MainContent_ddlSerieGuiaEdicion').prop('readonly', true);
            $('#MainContent_txtNumeroGuiaEdicion').prop('readonly', true);
            $('#MainContent_txtNroRucTransportistaEdicion').prop('readonly', true);
            $('#MainContent_txtTransportistaEdicion').prop('readonly', true);
            $('#MainContent_txtDireccionTransportistaEdicion').prop('readonly', true);
...
function F_ImpresionGrilla(Fila,rplc,TipoImp,NroCopias) {
 if (F_PermisoOpcion(CodigoMenu, '4000205', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
...
function F_ImpresionDefinitiva(CodMenu, Codigo, SerieDoc, CodTipoDoc, TipoImp, NroCopias) {
    ...
    if (CodTipoDoc ==1)
    {
    var NombreArchivo = 'rptFacturaImpresionTicketNV.rpt';
    ...
    {
    var NombreArchivo = 'rptElectronicaBO.rpt';
    }else
    {
    var NombreArchivo = 'rptProforma.rpt';
    }
}
