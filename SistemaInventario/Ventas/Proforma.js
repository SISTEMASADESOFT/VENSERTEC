var AppSession = "../Ventas/Proforma.aspx";
...
//                MostrarEspera(false);
    ...
    var TextHighlightCss='#FFFFE0';

    $('#ddlCarriers option:selected').css(TextHighlightCss);

//    $('#MainContent_ddlMoneda option:selected').css(TextHighlightCss);  

    $('#MainContent_ddlSerie option:selected').css(TextHighlightCss); 
...
function F_ValidarGrabarDocumento(){
    ...
    try 
        ...
        if ($(Cuerpo + 'txtNumero').val()=='')
                Cadena=Cadena + '<p></p>' + 'Numero de Cotizacion';
