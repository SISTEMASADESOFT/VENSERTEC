...
{
    public partial class RegistroFacturaLUBRISERVICIOS : System.Web.UI.Page
    {
        ...
        public String F_EdicionFactura_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EdicionFactura(obj_parametros, ref MsgError, ref CodTraslado);
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado)
        {
