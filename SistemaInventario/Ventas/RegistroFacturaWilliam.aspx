<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaWilliam.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaWilliam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaWilliam.js" charset="UTF-8"></script>
                                         ...
                                         <td>                                  
                                                         <div id="Div_direccion">
                                                            <asp:DropDownList ID="ddldireccionNueva" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="550" Font-Size="Small">
                                                            </asp:DropDownList>
                                                        </div>
                                                      </td>
                                                         <td>
                                                            ...
                                                            <td style="display: none" id="td3">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td id="td4">
                                                                            <asp:TextBox ID="TextBox2" runat="server" Width="25px" ForeColor="Blue" Font-Names="Arial"
                                                                                Font-Bold="True"></asp:TextBox>
                                                                        </td>
                                                                        <td style="font-weight: bold;">
                                                                            Num.
                                                                        ...
                                                                        <td id="td5">
                                                                            <asp:TextBox ID="TextBox3" runat="server" Width="42px" ForeColor="Blue" Font-Names="Arial"
                                                                                Font-Bold="True"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                             ...
                                             <td>
                                                    <asp:TextBox ID="txtTransportistaEdicion" runat="server" Width="257px" Font-Names="Arial"
                                                      ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                               </td>
                                             <td style="font-weight: bold;padding-left: 5px;">
                                        Direccion
                                 ...
                                 C.AGENCIA
                                   ...
                                   Placa
                                                 ...
                                                 <td style="font-weight: bold">
                                                                <asp:TextBox ID="txtLicenciaGuiaEdicion" runat="server" Width="100" Font-Names="Arial" ForeColor="Blue"
                                                                    Font-Bold="True"></asp:TextBox>
                                                            </td> 
                                                </tr>
                                                </table>
