...
{
    public partial class RegistroFacturaMercedes : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref P_EDITAR_PRECIOS, ref P_FILTRA_SERVICIOS, ref P_FILTRA_ACTIVOS, ref ddlSerieGuiaEdicion, ref ddlVendedor, ref ddlVendedorEdicion);
            ...
            str_resultado =
                ...
                Session["ComisionTarjeta"].ToString(); //36
        ...
        public String F_AgregarTemporal_NET(String arg)
        {
            ...
            try
            {
                ...
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref PorcentajeTarjeta, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref NotaPedido);
            ...
            str_resultado =
               ...
               Math.Round(Total, 2).ToString()
                ...
                + "~" +
                Math.Round(ComisionTarjeta, 2).ToString()
                + "~" +
                Math.Round(PorcentajeTarjeta, 2).ToString();
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboguia_edicion, ref DropDownList ddl_CodVendedor,ref DropDownList ddl_VendedorEdicion)
        ...
        public void P_CargarGrillaTemporal(Hashtable objTablaFiltro, Int32 Codigo,ref Decimal PorcentajeTarjeta, ref GridView grvDetalle,
            ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura, ref Int32 NotaPedido )
        {
            ...
            if (Codigo != 0)
            {
                ...
                PorcentajeTarjeta =Convert.ToDecimal(Session["ComisionTarjeta"]) ;
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.Igv = Convert.ToDecimal(objTablaFiltro["Filtro_Igv"]);
            objEntidad.Total = Convert.ToDecimal(objTablaFiltro["Filtro_Total"]);
            objEntidad.TotalTarjeta = Convert.ToDecimal(objTablaFiltro["Filtro_TotalTarjeta"]);
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    P_CargarGrillaTemporal(obj_parametros, objReemplazo.Codigo, ref PorcentajeTarjeta, ref grvDetalleArticulo, ref stotalo, ref igvo, ref totalo, ref NotaPedido);
            ...
            str_resultado =
                ...
                + "~" +
                Math.Round(ComisionTarjeta, 2).ToString()//5
                + "~" +
                Math.Round(PorcentajeTarjeta, 2).ToString();//6
        ...
        public String F_AgregarTemporalNP_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    P_CargarGrillaTemporal(obj_parametros, objReemplazo.Codigo, ref PorcentajeTarjeta, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref NotaPedido);
