...
{
    public partial class RegistroCotizacionLUBRISERVICIOS : System.Web.UI.Page
    {
        ...
        public String F_LlenarGridDetalle_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodDocumentoVenta = Convert.ToInt32(Codigo);
                objEntidad.CodTipoDoc = Convert.ToInt32(CodTipoDoc);
                grvDetalleAuditoria.DataSource = objOperacion.F_Proforma_Auditoria(objEntidad);
                grvDetalleAuditoria.DataBind();
        ...
        public String F_LlenarGridDetalle_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodDocumentoVenta = Convert.ToInt32(Codigo);
                objEntidad.CodTipoDoc = Convert.ToInt32(CodTipoDoc);
                grvDetalleObservacion.DataSource = objOperacion.F_ProformaDet_Listar(objEntidad);
                grvDetalleObservacion.DataBind();
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref P_EDITAR_PRECIOS, ref P_FILTRA_SERVICIOS, ref P_FILTRA_ACTIVOS, ref ddlSerieGuiaEdicion,ref ddlVendedor);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                    ...
                    ref NroOperacion, ref NumeroOC, ref Requerimiento,ref Observacion);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboguia_edicion,ref DropDownList ddl_CodVendedor)
        {
            ...
            dta_consulta = objOperacionTCDocumentos.F_TCDocumentos_ListarFacturacion_Cotizacion();
        ...
        public void P_Obtener_TipoCambio(Hashtable objTablaFiltro, ref Decimal TipoCambio, ref Decimal TipoCambioParalelo, ref Decimal TipoCambioParaleloCompra)
        {
            ...
            dta_consulta = objOperacion.F_TCTipoCambio_Select_William(objEntidad);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 15: //Cotizacion
                    ...
                    objEntidadProforma.NroOC = objEntidad.NroOC;
                    ...
                    objEntidadProforma.NroOperacion = objEntidad.NroOperacion;
                    ...
                    objEntidadProforma.KM = objEntidad.KM;
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_Proformacab_Listar_William(objEntidad);
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                                    ...
                                    ref String NroOperacion, ref String NumeroOC, ref string Requerimiento,ref string Observacion)
        {
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_ValidarCotizacion(obj_parametros, ref str_mensaje_operacion);
        ...
        public void P_ValidarCotizacion(Hashtable objTablaFiltro, ref String Mensaje)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            Mensaje = objOperacion.F_Proforma_Validar_Factura(objEntidad).MsgError;
        }
