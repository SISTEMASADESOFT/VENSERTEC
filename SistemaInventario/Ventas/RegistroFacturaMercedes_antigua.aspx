<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMercedes_antigua.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMercedes_antigua" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMercedes_antigua.js" charset="UTF-8"></script>
    ...
    <div id="div_Editar" style="display: none;">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <table>
                ...
                <tr>
                    <td id="rq1" style="font-weight: bold">
                        Requerimiento
                    </td>
                    <td>
                        <table>
