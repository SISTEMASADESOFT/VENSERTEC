...
{
    public partial class RegistroFacturaMercedes_antigua : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 15: //Cotizacion
                    ...
                    objOperacionProforma.F_Proformas_Insert_Mercedes(objEntidadProforma);
                ...
                case 16: //Nota de Pedido
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NP_OC_Mercedes(objEntidad);
                ...
                default: //Facturas y Boletas
                    if (objEntidad.NotaPedido == 0) //Insert Normal
                        objOperacion.F_DocumentoVentaCab_Insert_Mercedes(objEntidad);
                    else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Mercedes(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_Mercedes(objEntidad);
