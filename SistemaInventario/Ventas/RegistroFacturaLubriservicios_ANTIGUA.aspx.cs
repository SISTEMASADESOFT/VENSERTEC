...
{
    public partial class RegistroFacturaLubriservicios_ANTIGUA : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref P_EDITAR_PRECIOS, ref P_FILTRA_SERVICIOS, ref P_FILTRA_ACTIVOS, ref ddlSerieGuiaEdicion);
                P_Obtener_TipoCambio(obj_parametros, ref TC, ref TC_Paralelo);
        ...
        public String F_VerUltimoPrecio_NET(String arg)
        {
            ...
            try
            {
                ...
                P_VerUltimoPrecio(obj_parametros, ref Precio, ref Moneda, ref Fecha, ref Cantidad,
                    ref Modelo, ref Motor, ref Posicion, ref Año, ref Medida, ref DscFamilia, ref CodigoProducto);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                    ...
                    ref NroOperacion, ref NumeroOC, ref Requerimiento);
        ...
        public void P_Obtener_TipoCambio(Hashtable objTablaFiltro, ref Decimal TipoCambio, ref Decimal TipoCambioParalelo)
        {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 15: //Cotizacion
                    ...
                    objOperacionProforma.F_Proformas_Insert(objEntidadProforma);
                ...
                case 16: //Nota de Pedido
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                ...
                default: //Facturas y Boletas
                    if (objEntidad.NotaPedido == 0) //Insert Normal
                        ...
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad);
        ...
        public void P_Buscar_NP(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_Listar_NP(objEntidad);
        ...
        public void P_VerUltimoPrecio(Hashtable objTablaFiltro, ref Decimal UltimoPrecio, ref String UltimaMoneda, ref String UltimaFecha, ref Decimal UltimaCantidad,
            ref String Modelo, ref String Motor, ref String Posicion, ref String Año, ref String Medida, ref String DscFamilia, ref String CodigoProducto)
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                DscFamilia = Convert.ToString(dta_consulta.Rows[0]["DscFamilia"]);
                CodigoProducto = Convert.ToString(dta_consulta.Rows[0]["CodigoProducto"]);
            }
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                                    ...
                                    ref String NroOperacion, ref String NumeroOC, ref string Requerimiento)
        {
