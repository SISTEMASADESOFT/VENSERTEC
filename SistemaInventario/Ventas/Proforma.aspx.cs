    ...
    public partial class Proforma : System.Web.UI.Page
    {
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblID.Text != "")
                {
                    objEntidad.CodProforma = Convert.ToInt32(lblID.Text);
                    grvDetalle.DataSource = objOperacion.F_ProformaCab_Select_Detalle(objEntidad);
                    grvDetalle.DataBind();
                }
            }
        }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlIgv,
                    ref ddlSerie, ref ddlSerieConsulta);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
             ref DropDownList ddl_comboigv, ref DropDownList ddl_combofactura, ref DropDownList ddl_comboserieconsulta)
        {
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " PrecioDscto = '" + (item.Precio / (Convert.ToDecimal(objTablaFiltro["Filtro_TasaIgv"]))) * (1 - (Convert.ToDecimal(item.Dscto) / 100)) + "'";
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_ProformaCab_Select(objEntidad);
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Update_NOStock(objEntidad);
