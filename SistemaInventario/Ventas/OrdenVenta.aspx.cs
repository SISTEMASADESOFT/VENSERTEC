...
namespace SistemaInventario.Ventas
{
    public partial class OrdenVenta : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_monedacomision_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda,ref ddlIgv, ref ddlSerie,ref ddlSerieConsulta);
     ...
     ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta)
        {
        ...
        public void P_Obtener_Correlativo(Hashtable objTablaFiltro, ref String Numero)
        {
            ...
            objEntidad.CodDoc = Convert.ToInt32(objTablaFiltro["Filtro_CodSerie"]);
            objEntidad.CodSede = Convert.ToInt32(Session["CodSede"]);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            {
                objEntidad.Desde = Convert.ToDateTime("01/01/1900");
                objEntidad.Hasta = Convert.ToDateTime("01/01/1900");
            }
