<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaLubriservicios_ANTIGUA.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaLubriservicios_ANTIGUA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaLubriservicios_ANTIGUA.js" charset="UTF-8"></script>
                        ...
                        <asp:TemplateField HeaderText="Precio" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtPrecio" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    ...
                                    onblur="F_ActualizarPrecio(this.id); return false;" Enabled="False"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        <tr>
                            ...
                            <td style="font-weight: bold;">
                                <div>
                                    <asp:Label ID="Label4" runat="server" Text="T.C." Font-Bold="True"></asp:Label>
                                </div>
                            </td>
                            <td style="font-weight: bold;">
                                <div style="display: none">
        ...
        <div id="div_grvConsultaArticulo" style="padding-top: 5px;">
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Codigo">
                        ...
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="hlkCodigo" Font-Underline="true" ForeColor="Blue"
                                ...
                                ToolTip="Ver Series"> </asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="ALMACEN 1">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
        ...
        <table>
            ...
            <tr>
              ...
              <tr  id="tdCodigo">
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtCodigo" runat="server" Width="260px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" Font-Size="Small"  ></asp:TextBox>
                </td>
            </tr>
              <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtFamilia" runat="server" Width="260px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" Font-Size="Small"  ></asp:TextBox>
                </td>
            </tr>
        </table>
