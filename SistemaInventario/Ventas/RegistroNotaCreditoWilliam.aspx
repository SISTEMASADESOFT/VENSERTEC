<%@ Page Title="Nota de Credito-Venta" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="RegistroNotaCreditoWilliam.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroNotaCreditoWilliam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroNotaCreditoWilliam.js" charset="UTF-8"></script>       
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                         <td>
                                            <asp:TextBox Style="width: 446px; position: absolute; color: blue; font-family: Arial;
                                                font-weight: bold; background: rgb(255, 255, 224);" ID="txtDireccion" runat="server"
                                                autocomplete="off"></asp:TextBox>
                                            <asp:DropDownList ID="ddlDireccion" Style="width: 470px" runat="server">
                                            </asp:DropDownList>
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="750px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                    ...
                    <Columns>                  
                       ...
                       <asp:TemplateField HeaderText="TK">
                        ...
                        <asp:TemplateField HeaderText="PDF">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf2" ImageUrl="~/Asset/images/pdf.png" ToolTip="Imprimir Nota de Credito"
...
<%--                        <asp:TemplateField HeaderText="ID">
    ...
    <input id="hfDireccion" type="hidden" value="0" />
