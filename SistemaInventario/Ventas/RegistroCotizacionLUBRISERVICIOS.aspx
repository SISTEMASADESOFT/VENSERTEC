<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroCotizacionLUBRISERVICIOS.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionLUBRISERVICIOS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionLUBRISERVICIOS.js" charset="UTF-8"></script>   
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo">
        ...
        <asp:Label ID="Label3" runat="server" Text="REGISTRO DE COTIZACION" Font-Bold="False"
    ...
    <div id="divTabs" style="width: 1200px">
        ...
        <div id="tabRegistro">
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 1100px">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td id="div_Cliente">
                                            <asp:TextBox ID="txtCliente" runat="server" Width="482px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td id="div_correos" style="padding-left: 10px; width: 332px;display: none;">
                                            <select id="ddlCorreos" style="width: 330px">
                                            </select>
                                        </td>
                                        <td style="padding-left: 10px; width: 332px;display: none;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td id="div_Placa1">
                                            <asp:TextBox ID="txtPlaca" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td id="div_Placa2">
                                        ...
                                        <td id="div_KM" style="font-weight: bold;">
                                            KM
                                        </td>
                                        <td id="div_txtKM">
                                        ...
                                        <td align="left" colspan="7">
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td id="td_Impresora" style="width: 90px">
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSubTotal" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtIgv" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="True" Text="0.00" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        total
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtTotal" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="True" Text="0.00" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        VENDEDOR
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="840px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div id="div_trResponsableNP" style="display: none">
                    <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <div id="div_ResponsableNP">
                                                    <asp:DropDownList ID="ddlResponsableNP" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True" Width="218">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                ...
                <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix"
                    id="div_CabeceraGuia" style="display: none">
                    Datos de la guia
                </div>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: 103px;">
                                                        Fecha
                                                    </td>
                                                    <td>
                    ...
                    <Columns>
                      <%--  <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                       ...
                       <%-- <asp:TemplateField HeaderText="GR">
                        ...
                        <asp:TemplateField HeaderText="TK">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgTCK" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="Imprimir Ticket" OnClientClick="F_ImpresionGrilla(this,'imgTCK','TK',1); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="IMP">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="Imprimir Factura" OnClientClick="F_ImpresionGrilla(this,'imgPdf','IMP',1); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf2" ImageUrl="~/Asset/images/pdf.png" ToolTip="Generar Version PDF"
                                    OnClientClick="F_ImpresionGrilla(this,'imgPdf2','PDF',0); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%--     <asp:BoundField DataField="SubTotal" HeaderText="SubTotal" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Igv" HeaderText="Igv" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>--%>
                   ...
                   <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                         ...
                         <ItemTemplate>
                             <asp:HyperLink runat="server" ID="lblProducto" Font-Underline="true" ForeColor="Blue"
                                 Style="cursor: hand" Text='<%# Bind("Producto") %>' onclick="F_AgregarArticuloFromDsc(this.id); return false;" class="detallesart" >
                             </asp:HyperLink>
                         </ItemTemplate>
                     </asp:TemplateField>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtArticuloAgregar" runat="server" Width="660px" Font-Names="Arial"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDsct" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
    ...
    <div id="div_Editar" style="display: none;">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <table>
                ...
                <tr>
                    <td id="div_KMEdicion" style="font-weight: bold">
                        KM
                    </td>
                    <td>
                        <table>
                            <tr>
                                <td id="div_txtKMEdicion">
                ...
                <tr>
                    <td id="rq1" style="font-weight: bold;display: none;">
                        Requerimiento
                    </td>
                    <td>
                        <table>
                            <tr>
                                <td id="rq2" style="display: none;">
                 ...
                 <tr>
                    <td id="Td1" style="font-weight: bold;display: none;">
                        Observacion
                    </td>
                    <td>
                        <table>
                            <tr>
                                <td id="Td2" style="display: none;">
                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                        Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
            ...
            <div>
                <span>LAS COBRANZAS SOLO SE MODIFICARAN DEL DIA ACTUAL</span>
            </div>
                        ...
                        <td  style="display: none;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPlacaTrasladoEdicion" runat="server" Width="60" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold">
                                        Marca
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMarcaGuiaEdicion" runat="server" Width="190" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold">
                                        Licencia
                                    ...
                                    <td style="padding-left: 11px;">
                                        <asp:TextBox ID="txtLicenciaGuiaEdicion" runat="server" Width="120" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold">
                                        Numero Bultos
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNuBultosEdicion" runat="server" Width="30" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold">
                                        Peso (kg)
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPesoEdicion" runat="server" Width="30" Font-Names="Arial" ForeColor="Blue"
                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
    ...
    <div id="div3" style="display: none">
     ...
     <div id="div_NumeroDocumento" style="background-color: #CCE6FF; text-align: center;
        ...
        <br />
        <center>
            <asp:Label ID="Label5" runat="server" Text="Numero de Cotizacion" Font-Bold="true"
