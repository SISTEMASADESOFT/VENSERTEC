var AppSession = "../CuentasPorCobrar/RegistroPagos.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_btnEdicionMedioPago').click(function () {
        ...
        if ($(Cuerpo + 'ddlDetraccionEdicion').val() == 1 & ($(Cuerpo + 'ddlMedioPagoEdicion').val() != '1'  & $(Cuerpo + 'ddlMedioPagoEdicion').val() != '6') & $('#MainContent_txtNroOperacionEdicion').val() == '')
        {
            toastr.warning('DEBE ESPECIFICAR UN NUMERO DE OPERACION');
            return false;
        }

           if ($(Cuerpo + 'ddlDetraccionEdicion').val() == 1 &  ($(Cuerpo + 'ddlMedioPagoEdicion').val()!='1' & $(Cuerpo + 'ddlMedioPagoEdicion').val()!='5' & $(Cuerpo + 'ddlMedioPagoEdicion').val()!='6') && $(Cuerpo + 'txtNroOperacionEdicion').val()=='') {
            ...
            if ($(Cuerpo + 'ddlDetraccionEdicion').val() == 2 &  $.trim($(Cuerpo + 'txtDetraccionEdicion').val())=='') {
                toastr.warning('Nro Detraccion');
                return false;
            }
    ...
    if (F_PermisoOpcion(CodigoMenu, 5000101, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
     ...
     $('#MainContent_btnEditarComisioTarjeta').click(function () {
  
     try 
        {
       
         F_GuardarCambiosComisionTarjeta();
...
//          Cadena=Cadena + '<p></p>' + "Cliente Varios";
    ...
    $('#MainContent_txtCT').blur(function () {
   
   if(parseFloat($('#MainContent_txtCT').val())<parseFloat($('#MainContent_txtAcuentaEdicion').val())) {
   $('#MainContent_txtCT').val($('#hfCT').val());
   toastr.warning('LA COMISION TARJETA NO PUEDE SER MENOR AL VALOR A CUENTA');
   }
    return true;
});
    ...
    $(document).on("change", "select[id $= 'MainContent_ddlMedioPago']",function () {
     ...
     var ComisionTarjeta = 0;

     AcuentaCobranza =Number($('#MainContent_txtTotalCobranza').val()).toFixed(2);
     ComisionTarjeta = Number($('#hfComisionTarjeta').val()).toFixed(2);
     F_EditarDetalle();
         if ( $('#MainContent_ddlMedioPago').val()!=10)
         {
         $('#MainContent_txtComisionTarjeta').val('0.00');
         }
...
$(document).on("change", "select[id $= 'MainContent_ddlMedioPago']", function () {
             ...
             {
                $('#MainContent_ddlDetraccion').val(1);
            $('#MainContent_txtDetraccionEdicion').val('');
                 $('#MainContent_ddlDetraccion').prop('disabled',false);
                  $('#MainContent_ddlCuenta').prop('disabled',false); 
                   $('#MainContent_ddlBanco').prop('disabled',false); 
             }else{
                  $('#MainContent_ddlDetraccion').val(1);
            $('#MainContent_txtDetraccion').val('');
                 $('#MainContent_ddlDetraccion').prop('disabled',true);
      $('#MainContent_txtDetraccion').prop('disabled',true);
             }
            
});

$(document).on("change", "select[id $= 'MainContent_ddlMedioPagoEdicion']", function () {
             if ($('#MainContent_ddlMedioPagoEdicion').val()==3)
             {
                $('#MainContent_ddlDetraccionEdicion').val(1);
            $('#MainContent_txtDetraccionEdicion').val('');
                 $('#MainContent_ddlDetraccionEdicion').prop('disabled',false);
      $('#MainContent_txtDetraccionEdicion').prop('disabled',false);
             }else{
                  $('#MainContent_ddlDetraccionEdicion').val(1);
            $('#MainContent_txtDetraccionEdicion').val('');
                 $('#MainContent_ddlDetraccionEdicion').prop('disabled',true);
      $('#MainContent_txtDetraccionEdicion').prop('disabled',true);
             }
            
});

$(document).on("change", "select[id $= 'MainContent_ddlDetraccion']", function () {
             if ($('#MainContent_ddlDetraccion').val()==1)
             {
                  $('#MainContent_txtDetraccion').val('');
                  $('#MainContent_txtDetraccion').prop('disabled',true);  
                  ...
                  $('#MainContent_ddlMedioPago').prop('disabled',false);    
             }
             else
             {
                  $('#MainContent_txtDetraccion').val('');
                  ...
                  $('#MainContent_ddlMedioPago').prop('disabled',true);  
                  $('#MainContent_txtDetraccion').prop('disabled',false);  
             }
             F_ListarNroCuenta();
});

$(document).on("change", "select[id $= 'MainContent_ddlDetraccionEdicion']", function () {
              if ($('#MainContent_ddlDetraccionEdicion').val()==1)
             {
                  $('#MainContent_txtDetraccionEdicion').val('');
                  $('#MainContent_txtDetraccionEdicion').prop('disabled',true);  
                  $('#MainContent_ddlMedioPagoEdicion').val(1);
                  $('#MainContent_ddlMonedaEdicion').val(1);
                  $('#MainContent_ddlMonedaEdicion').prop('disabled',false);                 
                  $('#MainContent_ddlMedioPagoEdicion').prop('disabled',false);    
             }
             else
             {
                  $('#MainContent_txtDetraccionEdicion').val('');
                  $('#MainContent_ddlMedioPagoEdicion').val(3);
                  $('#MainContent_ddlMonedaEdicion').val(1);
                  $('#MainContent_ddlMonedaEdicion').prop('disabled',true);  
            ...
            (
                ...
                function (result) {
                    ...
                    {                        
                        ...
                        F_Update_Division_HTML('div_CajaFisicaEdicion', result.split('~')[36]);
                        ...
                        F_Update_Division_HTML('div_detraccion', result.split('~')[32]);
                        F_Update_Division_HTML('div_DetraccionEdicion', result.split('~')[33]);
                        F_Update_Division_HTML('div_MedioPagoEdicion', result.split('~')[35]);
                        $('#hfComisionTarjeta').val( result.split('~')[34]);
                        $('#MainContent_lblCT').text("TOTAL TARJETA (+"+result.split('~')[34]+"%)");
                        ...
                        $('#MainContent_ddlCajaFisicaEdicion').val(result.split('~')[36]);
                        ...
                        $('#MainContent_ddlCajaFisicaConsulta').val(0);
                        ...
                        $('#MainContent_ddlDetraccion').css('background', '#FFFFE0');
                        $('#MainContent_ddlDetraccionEdicion').css('background', '#FFFFE0');
                        ...
                        if ($('#MainContent_ddlDetraccion').val()==1 && $('#MainContent_ddlMoneda').val()==1 ){
                            $('#MainContent_txtDetraccion').prop('disabled',true);
                        }
                        else
                        {
        ...
        try 
        {
            ...
            var objParams = {
                ...
                if (str_resultado_operacion == "1") 
                {
                    ...
                    $('#MainContent_txtCobroOperacion').val(parseFloat($('#MainContent_txtTotalDeuda').val() - $('#MainContent_txtTotalCobranza').val()).toFixed(2));                    
                    $('#hfComisionTarjeta').val(result.split('~')[9]);                    
                    $('.ccsestilo').css('background', '#FFFFE0');
                    F_MostrarTotales();
                    Buscando = false;
                }
...
var Subtotal=0;
     ...
     var Cuerpo='#MainContent_'
     var ComisionTarjeta=$('#hfComisionTarjeta').val();
...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        if ($(Cuerpo + 'ddlMoneda').val()=='2' & $(Cuerpo + 'ddlDetraccion').val()==2){
                    Cadena=Cadena + '<p></p>' + 'La detraccion no puede grabarse en dolares';
          }
            ...
            else
            {
                ...
                if (Math.abs(parseFloat($('#MainContent_txtTotalDeuda').val())) < 0 )
                        Cadena=Cadena + '<p></p>' + 'LO PAGADO DEBE SER MAYOR O IGUAL A CERO (0)';            
...
if (!F_SesionRedireccionar(AppSession)) return false;
  ...
  try 
        ...
        $('#MainContent_grvFacturaCobranzas :checkbox').each(function () {
            ...
            lblCT = chkSi.replace('chkEditar', 'lblCT');
            ...
            if ($(chkSi).is(':checked')) 
            {
                var objDetalle = {
                    ...
                    CT: $(lblCT).text().replace('S/', '').replace('$', '').trim(),
                    TC: $(lblTC).text(),
        ...
        var objParams = {   
                             ...
                             Filtro_ComisionTarjeta:       $(Contenedor + 'txtComisionTarjeta').val(),
                             ...
                             Filtro_CodTipoCobranza:       $('#MainContent_ddlDetraccion').val(),
                             Filtro_Detraccion:            $('#MainContent_txtDetraccion').val()
                         };
...
if (!F_SesionRedireccionar(AppSession)) return false;
        ...
        $(Contenedor + 'ddlDetraccion').val('1');  
        $(Contenedor + 'txtDetraccion').val('');
        $('#hfCodCtaCte').val('0');
...
if (!F_SesionRedireccionar(AppSession)) return false;
    ...
    if($('#MainContent_ddlDetraccion').val()==2)
    FlagDetraccion=1
...
function F_ListarBancosEdicion() {
if (!F_SesionRedireccionar(AppSession)) return false;
    var arg;
    var FlagDetraccion=0
    try {

      if($('#MainContent_ddlDetraccionEdicion').val()==2)
    FlagDetraccion=1
        ...
        F_ListarBancos_NET
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                     F_Update_Division_HTML('div_BancoEdicion', result.split('~')[3]);
                            $('#MainContent_ddlBancoEdicion').css('background', '#FFFFE0');   
                              F_ListarNroCuentaEdicion();    
                    }
                    else {
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            var hfCodCajaFisica = '#' + imgID.replace('imgEditar', 'hfCodCajaFisica');
            ...
            var hfCodTipoCobranza = '#' + imgID.replace('imgEditar', 'hfCodTipoCobranza');
            var hfDETRACCION = '#' + imgID.replace('imgEditar', 'hfDETRACCION');
            ...
            $('#MainContent_ddlMedioPagoEdicion').val($(hfCodMedioPago).val());
            $('#MainContent_ddlCajaFisicaEdicion').val($(hfCodCajaFisica).val());
            ...
            $('#MainContent_ddlDetraccionEdicion').val($(hfCodTipoCobranza).val());
            $('#MainContent_txtDetraccionEdicion').val($(hfDETRACCION).val());
            $('#hfdetraccion').val($(hfDETRACCION).val());          
            $('#hfRecibo').val($(hfnrorecibo).val());
            $('#hfCodCajaFisicaEdicion').val($(hfCodCajaFisica).val());
...
function F_EdicionMedioPago(){
  try 
        ...
        var objParams = {   
            ...
            Filtro_CodtipoCobranza:               $('#MainContent_ddlDetraccionEdicion').val(),
            Filtro_Detraccion:               $('#MainContent_txtDetraccionEdicion').val()
                         };
...
function F_EdicionDetalle(Fila, Tipo) {
    ...
    var lblCT = Fila.replace('chkEditar', 'lblCT');
    ...
    if ($('#MainContent_ddlMedioPago').val()==10)
    $('#MainContent_txtCT').val($(lblCT).text());
    else
      $('#MainContent_txtCT').val('0.00'); 
...
var Subtotal=0;
    ...
    if ($(Cuerpo + 'ddlMedioPago').val()==10){
        $(Cuerpo + 'txtCT').val(parseFloat($(Cuerpo + 'txtAcuentaEdicion').val() * (1 + ComisionTarjeta/100)).toFixed(2));
        $('#hfCT').val(parseFloat($(Cuerpo + 'txtAcuentaEdicion').val() * (1 + ComisionTarjeta/100)).toFixed(2));
        }
    else{
        $(Cuerpo + 'txtCT').val('0.00');
        $('#hfCT').val('0.00');
        }
}
...
function F_EditarDetalle (){
    ...
    var ct = Number($('#MainContent_txtCT').val()).toFixed(2);
...
//    $('#MainContent_txtComisionTarjeta').val(ComisionTarjeta);
    ...
    if (Flag==0)
        $('#MainContent_txtCobroOperacion').val(parseFloat($('#MainContent_txtTotalDeuda').val())  - parseFloat($('#MainContent_txtTotalCobranza').val())) ;



    var MontoVuelto = parseFloat($('#MainContent_txtCobroOperacion').val())  -  (parseFloat($('#MainContent_txtTotalDeuda').val())  - parseFloat($('#MainContent_txtTotalCobranza').val())) ;
    var VueltoSoles = 0;
    var VueltoDolares = 0;
...
function F_Cambio_Moneda_Detraccion(){
...
function F_EditarComisionTarjeta(Fila) {
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            var imgID = Fila.id;
            var Col = imgID.split('_')[3];
            var hfCodMoneda = '#' + imgID.replace('imgEditar', 'hfCodMoneda');
            var lblCodigo = '#' + imgID.replace('imgEditar', 'hfCodigo');
            var grvNombre = 'MainContent_grvConsulta_hfDetalleCargado_' + Col;
            ...
            MostrarEspera(true);
            F_EdicionComisionTarjeta_Net(arg, function (result) {
            ...
            if (str_resultado_operacion === "0")
            {
                    F_Update_Division_HTML('div_grvDetalleEdicionComisionTarjeta', result.split('~')[2]); 
                            $('.ccsestilo').css('background', '#FFFFE0');
                            
                    F_ListarBancosEdicion();
...
function F_GuardarCambiosComisionTarjeta() {
 try 
        {                             
    
     var arrDetalle = new Array();
     var F=0;
     $('#MainContent_grvDetalleEdicionComisionTarjeta .ccsestilo').each(function () {
     txtTotalTarjeta = '#MainContent_grvDetalleEdicionComisionTarjeta_txtTotalTarjeta_'+F;
      hfCodCobranzadet = txtTotalTarjeta.replace('txtTotalTarjeta', 'hfCodCobranzadet');
      hfCodMoneda = txtTotalTarjeta.replace('txtTotalTarjeta', 'hfCodMoneda');
      var objDetalle = {
                    hfCodCobranzadet: $(hfCodCobranzadet).val(),
                    TotalTarjeta: $(txtTotalTarjeta).val(),
                    CodMoneda: $(hfCodMoneda).val()
    ...
    var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
    MostrarEspera(true);
    F_GuardarCambiosComisionTarjeta_NET(arg, function (result) {
...
function F_Inicializar_Caja_Texto()
{
    ...
    $('#MainContent_txtCT').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtDetraccion').css('background', '#FFFFE0');

    $('#MainContent_ddlDetraccion').css('background', '#FFFFE0');
    
    $('#MainContent_txtComisionTarjeta').css('background', '#FFFFE0');
     
    $('#MainContent_txtDetraccionEdicion').css('background', '#FFFFE0');
