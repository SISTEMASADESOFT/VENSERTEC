<%@ Page Title="Pagos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroPagos.aspx.cs" Inherits="SistemaInventario.CuentasPorPagar.RegistroPagos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroPagos.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divTabs" style="width: 1250px">
        <ul>
            ...
            <li id="liDetallado" style="display: none;" ><a href="#tabDetallado">Detallado</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 5px">
                                            <asp:TextBox ID="txtFiltroFechaHasta" runat="server" Width="55" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" CssClass="Jq-ui-dtp" ReadOnly="False"></asp:TextBox>
                                        </td>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td  style="padding-left: 23px">
                                                    <div id="div_detraccion">
                                                        <asp:DropDownList ID="ddlDetraccion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 16px;display:none">
                                                        <asp:TextBox ID="txtnroRecibo" runat="server" Width="40px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                      <td  style="padding-left: 16px;display:none">
                                                        Cobrador
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td  style="font-weight: bold; padding-left: 5px">
                                                    ...
                                                    <td  style="padding-left: 5px">
                                                        <asp:TextBox ID="txtDetraccion" runat="server" Width="120px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                          <td style="font-weight: bold;padding-left: 30px;display:none">
                                             <asp:Label ID="lblCT" runat="server" Text="LabelParalelo" Font-Bold="True"></asp:Label>
                                        </td>
                                        <td id="Td4" style="padding-left: 16px;display:none">
                                            <asp:TextBox ID="txtComisionTarjeta" runat="server" Width="130px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="1060px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td valign="top" style = "DISPLAY:none;">
                            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                                FACTURAS | BOLETAS | NOTA DE CREDITO | NOTA DE PEDIDO POR COBRAR
                            </div>
                            <div>
                                <table width="1210px">
                                    <tr align="right">
                                        ...
                                        <td style="padding-left: 2px;">
                                            <table>
                                                <tr>
                                                <td>    
                                            <div style="text-align: right; width: 110%; color: Black; font-weight: bold">
                                                Cantidad de registros :
                            ...
                            <div id="div_grvFacturaCobranzas" style="padding-top: 1px;">
                                <asp:GridView ID="grvFacturaCobranzas" runat="server" AutoGenerateColumns="False"
                                    ...
                                    Width="1200px" OnRowDataBound="grvFacturaCobranzas_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="Empresa" HeaderText="EMP" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Factura" ItemStyle-HorizontalAlign="Center">
                                      ...
                                      <%--   <asp:TemplateField HeaderText="CT" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditar" ImageUrl="~/Asset/images/btnEdit.gif"
                                    ToolTip="EDICION PAGO" OnClientClick="F_EditarMedioPago(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR PAGO" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cliente">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodTipoCobranza" runat="server" Value='<%# Bind("CodTipoCobranza") %>' />                             
                            </ItemTemplate>
                        </asp:TemplateField>
                      ...
                      <%--  <asp:BoundField DataField="Deuda" HeaderText="Deuda" DataFormatString="{0:N2}">
                       ...
                       <%-- <asp:BoundField DataField="CT" HeaderText="CT" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>--%>
            ...
            <div id="div_Eliminados" style="padding-top: 5PX;">
                <asp:GridView ID="grvEliminado" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Operacion" HeaderText="EGRESO" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>                    
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-weight: bold">
                                  ...
                                  <td  style="padding-left: 5px">
                              <div id="div_DetraccionEdicion">
                                  <asp:DropDownList ID="ddlDetraccionEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td  style="padding-left: 5px">
                                  <asp:TextBox ID="txtDetraccionEdicion" runat="server" Width="112px" Font-Names="Arial"
                                      ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                              </td>
                                 <td style="padding-left: 1px; font-weight: bold ;display:none">
                                    Recibo
                                </td>
                                 <td style="padding-left: 2px ;display:none" colspan='3'>
                                    ...
                                    <asp:GridView ID="grvDetalleEdicionComisionTarjeta" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Width="500px" >
                                         <Columns>
                                                        ...
                                                        <asp:BoundField DataField="TotalFactura" HeaderText="Cobranza Factura">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>                                                      
                                                          <asp:TemplateField HeaderText="Total Tarjeta" ItemStyle-HorizontalAlign="Center">
                                                              <ItemTemplate>
                                                                  <asp:TextBox runat="server" ID="txtTotalTarjeta" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                                      ...
                                                                      ></asp:TextBox>
                                                                      <asp:HiddenField ID="hfimporteFactura" runat="server" Value='<%# Bind("TotalFactura")    %>' />
                                                                      <asp:HiddenField ID="hfCodCobranzadet" runat="server" Value='<%# Bind("CodCobranzadet")    %>' />
                                                                      <asp:HiddenField ID="hfimporteTarjeta" runat="server" Value='<%# Bind("TotalTarjeta")    %>' />
                                                                      <asp:HiddenField ID="hfCodMoneda" runat="server" Value='<%# Bind("CodMoneda")    %>' />
                                                              </ItemTemplate>
                                                          </asp:TemplateField>
    ...
    <%--comision tarjeta--%>
    <div id="div_EdicionCT" style="display: none;">
            <div  class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" >   
                Edicion Comision Tarjeta
            </div>
            <div class="linea-button">
                <asp:Button ID="btnEditarComisioTarjeta" runat="server" Text="Guardar" class="ui-button
    ...
    <input id="hfCodtipocobranza" type="hidden" value="0" />
    <input id="hfdetraccion" type="hidden" value="0" />
    <input id="hfComisionTarjeta" type="hidden" value="0" />
    <input id="hfCT" type="hidden" value="0" />
</asp:Content>
