...
var CodigoMenu = 6000; var CodigoInterno = 2;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnAgregarFactura').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
//if (F_PermisoOpcion(CodigoMenu, 6000201, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try {
     ...
     try 
        {
            ...
            if (confirm("ESTA SEGURO DE GRABAR LA PERCEPCION"))
            F_GrabarDocumento();
...
//        return false;
    ...
    $('#div_Anulacion').dialog({
        resizable: false,
        modal: true,
        title: "Eliminacion de Percepcion",
        title_html: true,
        height: 190,
        width: 470,
        autoOpen: false
