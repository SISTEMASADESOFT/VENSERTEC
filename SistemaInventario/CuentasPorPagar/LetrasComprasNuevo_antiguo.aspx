<%@ Page Title="Letras - Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="LetrasComprasNuevo_antiguo.aspx.cs" Inherits="SistemaInventario.CuentasPorPagar.LetrasComprasNuevo_antiguo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="LetrasComprasNuevo_antiguo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 940px">
        REGISTRO DE LETRAS DE COMPRA</div>
   ...
   <td>
    ...
    <input id="hfCodEmpresa" type="hidden" value="3" />
