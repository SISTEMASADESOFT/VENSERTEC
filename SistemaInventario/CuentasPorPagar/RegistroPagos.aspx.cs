...
namespace SistemaInventario.CuentasPorPagar
{
    public partial class RegistroPagos : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ListarBancos_NET);
            ...
            CallbackManager.Register(F_EdicionComisionTarjeta_Net);
            CallbackManager.Register(F_Auditoria_Eliminados_NET);
            CallbackManager.Register(F_ObservacionesEliminados_NET);
            CallbackManager.Register(F_GuardarCambiosComisionTarjeta_NET);
        }
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("CT", typeof(string));
                    ...
                    dta_consultaarticulo.Columns.Add("DIAS", typeof(string));
        ...
        protected void grvEliminado_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    dta_consultaarticuloEliminado.Columns.Add("NUMERO", typeof(string));
                    ...
                    dta_consultaarticuloEliminado.Columns.Add("Emision", typeof(string));
                    dta_consultaarticuloEliminado.Columns.Add("Vencimiento", typeof(string));
                    dta_consultaarticuloEliminado.Columns.Add("DIAS", typeof(string));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_mediopagoedicion_html = "";
            ...
            String str_ddlCajaFisicaEdicion_html = "";
            ...
            String str_ddl_Detraccion_html = "";
            String str_ddl_DetraccionEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlMedioPago, ref ddlBanco, ref ddlBancoEdicion, ref ddlFiltroMoneda,
                    ref ddlCajaFisica, ref ddlMedioPagoConsulta, ref ddlCajaFisicaConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEmpresaConsulta2,
                    ref ddlEmpresaDetallado, ref ddlTipoDocDetallado, ref ddlAlmacenDetallado, ref ddltipodoc, ref ddltipodoc2, ref ddlEmpresaConsulta3,
                    ref ddlMedioPagoConsulta2, ref ddlAlmacenDetallado2, ref ddlCobrador, ref ddlVendedor, ref ddlRuta, ref ddlDetraccion, ref ddlDetraccionEdicion,
                    ref ddlMedioPagoEdicion, ref ddlCajaFisicaEdicion);
                ...
                str_ddl_mediopagoedicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlMedioPagoEdicion);
                ...
                str_ddlCajaFisicaEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlCajaFisicaEdicion);
                ...
                str_ddl_Detraccion_html = Mod_Utilitario.F_GetHtmlForControl(ddlDetraccion);
                str_ddl_DetraccionEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlDetraccionEdicion);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";
            }
            catch (Exception ex)
            ...
            str_ddl_Detraccion_html + "~" +  //32
            str_ddl_DetraccionEdicion_html + "~" + //33           
            Session["ComisionTarjeta"].ToString() + "~" +//34           
            str_ddl_mediopagoedicion_html + "~" + //35
            str_ddlCajaFisicaEdicion_html; //36; 
            return str_resultado;
        }
        ...
        public String F_AgregarTemporal_NET(String arg)
        {
            ...
            Decimal PorcentajeTarjeta = 0;
            Decimal ComisionTarjetaCobranzas = 0;
            Decimal ComisionTarjetaPagos = 0;
            String MsgError = "";
            Hashtable obj_parametros = null;
            ...
            str_resultado =
                ...
                + "~" +
                Session["ComisionTarjeta"].ToString();
        ...
        public String F_ListarBancos_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            String str_ddl_ddlBanco_html = "";
            String str_ddl_ddlBancoEdicion_html = "";
            Hashtable obj_parametros = null;

            try
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ListarBancos(obj_parametros, ref ddlBanco, ref ddlBancoEdicion);
                str_ddl_ddlBanco_html = Mod_Utilitario.F_GetHtmlForControl(ddlBanco);
                str_ddl_ddlBancoEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlBancoEdicion);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";
            }
            catch (Exception ex)
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_ddl_ddlBanco_html
                + "~" +
                str_ddl_ddlBancoEdicion_html;
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodPagoCab = Codigo;
                grvAuditoria.DataSource = objOperacion.F_PAGOSCAB_AUDITORIA(objEntidad);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_combomediopago,
                ref DropDownList ddl_combobanco, ref DropDownList ddl_combobanco_Edicion, ref DropDownList ddl_combomonedaFiltro, ref DropDownList ddl_CajaFisica,
                ref DropDownList ddl_combomediopagoconsulta, ref DropDownList ddl_CajaFisicaConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta,
                ref DropDownList ddl_comboempresaconsulta2, ref DropDownList ddl_comboempresadetallado, ref DropDownList ddl_TipoDocDetallado, ref DropDownList ddl_comboAlmacenDetallado,
                ref DropDownList ddl_tipodoc, ref DropDownList ddl_tipodoc2, ref DropDownList ddl_comboempresaconsulta3, ref DropDownList ddl_combomediopago2, ref DropDownList ddl_CajaFisicaConsulta2,
                ref DropDownList ddl_cobrador, ref DropDownList ddl_Vendedor, ref DropDownList ddl_Ruta, ref DropDownList ddl_Detraccion, ref DropDownList ddl_DetraccionEdicion,
            ref DropDownList ddl_combomediopagoedicion, ref DropDownList ddl_CajaFisicaEdicion)
        {
            ...
            ddl_combomediopagoedicion.Items.Clear();

            ddl_combomediopagoedicion.DataSource = dta_consulta;
            ddl_combomediopagoedicion.DataTextField = "DscAbvConcepto";
            ddl_combomediopagoedicion.DataValueField = "CodConcepto";
            ddl_combomediopagoedicion.DataBind();
            ...
            dta_consulta = (new CajaFisicaCN()).F_dtCajaFisica_Listar_william(1, 0, Convert.ToInt32(Session["CodEmpresa"]));
            ...
            ddl_CajaFisicaEdicion.Items.Clear();
            ddl_CajaFisicaEdicion.DataSource = dta_consulta;
            ddl_CajaFisicaEdicion.DataTextField = "Descripcion";
            ddl_CajaFisicaEdicion.DataValueField = "CodCajaFisica";
            ddl_CajaFisicaEdicion.DataBind();
            ...
            objEntidadAlmacen.CodEstado = 'A';

            //almacen local
            dta_consulta = null;
            dta_consulta = (new TCAlmacenCN()).F_TCALMACEN_LISTAR_TODOS_william(objEntidadAlmacen);
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodConcepto = 31;

            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_Detraccion.Items.Clear();

            ddl_Detraccion.DataSource = dta_consulta;
            ddl_Detraccion.DataTextField = "DscAbvConcepto";
            ddl_Detraccion.DataValueField = "CodConcepto";
            ddl_Detraccion.DataBind();

            ddl_DetraccionEdicion.Items.Clear();

            ddl_DetraccionEdicion.DataSource = dta_consulta;
            ddl_DetraccionEdicion.DataTextField = "DscAbvConcepto";
            ddl_DetraccionEdicion.DataValueField = "CodConcepto";
            ddl_DetraccionEdicion.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("CodTipoCobranza", typeof(string));
            //dta_consulta.Columns.Add("DETRACCION", typeof(string));
            dta_consulta.Columns.Add("CT", typeof(string));
            dta_consulta.Columns.Add("Vencimiento", typeof(string));
            dta_consulta.Columns.Add("DIAS", typeof(string));
            dta_consulta.Columns.Add("OPeracion", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref Int32 CodigoPagos, ref String MsgError)
        {
            ...
            else
            {
                ...
                foreach (dynamic item in jArr2)
                {
                    ...
                    //XmlDetalle = XmlDetalle + " CT = '" + item.CT + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodtipoCobranza = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoCobranza"]);
            objEntidad.Detraccion = Convert.ToString(objTablaFiltro["Filtro_Detraccion"]);
        ...
        public void P_LlenarGrillaVacia_Eliminado()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodTipoCobranza", typeof(string));
        ...
        public void P_ListarBancos(Hashtable objTablaFiltro,
           ref DropDownList ddl_comboBanco, ref DropDownList ddl_comboBanco_Edicion)
        {
            BancosCE objEntidad = null;
            BancosCN objOperacion = null;
            DataTable dta_consulta = null;
            ...
            dta_consulta = objOperacion.F_Listar_bancos(objEntidad);
            ...
            ref DropDownList ddl_combomediopago, ref DropDownList ddl_combobanco, ref DropDownList ddl_CajaFisica)
        {
            ...
            BancosCN objOperacionBancos = new BancosCN();
            BancosCE objEntidadBE = new BancosCE();
            objEntidadBE.flagdetraccion = 0;
            dta_consulta = objOperacionBancos.F_Listar_Bancos(objEntidadBE);
            ddl_combobanco.Items.Clear();
            ddl_combobanco.DataSource = dta_consulta;
            ddl_combobanco.DataTextField = "DscBanco";
            ddl_combobanco.DataValueField = "CodBanco";
            ...
            dta_consulta = (new CajaFisicaCN()).F_dtCajaFisica_Listar_william(1, 0, Convert.ToInt32(objTablaFiltro["Filtro_CodEmpresa"]));
            ddl_CajaFisica.Items.Clear();
            ddl_CajaFisica.DataSource = dta_consulta;
            ddl_CajaFisica.DataTextField = "Descripcion";
            ddl_CajaFisica.DataValueField = "CodCajaFisica";
        ...
        public void P_CAJA_X_EMPRESA(Hashtable objTablaFiltro, ref DropDownList ddl_CajaFisica)
        {
            ...
            dta_consulta = (new CajaFisicaCN()).F_dtCajaFisica_Listar_william(1, Convert.ToInt32(Session["CodSede"]), Convert.ToInt32(objTablaFiltro["Filtro_CodEmpresa"]));
        ...
        public String F_Auditoria_Eliminados_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodCobranzaCab = Codigo;
                //grvAuditoria.DataSource = objOperacion.F_PAGOSCAB_ELIMINADOS_AUDITORIA(objEntidad);
                grvAuditoria.DataBind();
        ...
        public String F_LlenarGridEliminar_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodPagoCab = Convert.ToInt32(Codigo);
                grvEliminar.DataSource = objOperacion.F_PagosDet_Eliminar_Listar(objEntidad);
        ...
        public String F_Observacion_Eliminados_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodPagoCab = Codigo;
                grvDetalleObservacionE.DataSource = objOperacion.F_PAGOSCAB_ELIMINADOS_OBSERVACION(objEntidad);
                grvDetalleObservacionE.DataBind();
        ...
        public String F_EdicionComisionTarjeta_Net(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String str_grv_grvDetalleEdicionComisionTarjeta_html = "";
            int Col = 0;
            int Codigo = 0;
            ...
            try
            {
                ...
                objEntidad.CodCobranza = Codigo;
                objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

                grvDetalleEdicionComisionTarjeta.DataSource = objOperacion.F_CobranzasDet_ComisionTarjeta(objEntidad);
                grvDetalleEdicionComisionTarjeta.DataBind();

                //se crea el html a partir del grid llenado
                str_grv_grvDetalleEdicionComisionTarjeta_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleEdicionComisionTarjeta);
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" +
                str_mensaje_operacion + "~" +
                str_grv_grvDetalleEdicionComisionTarjeta_html + "~" +
                grvNombre;

            return str_resultado;
        }

        public String F_GuardarCambiosComisionTarjeta_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_EdicionComisionTarjeta(obj_parametros, ref MsgError);
        ...
        public void F_EdicionComisionTarjeta(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            String XmlDetalle = "";
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " CodCobranzadet = '" + item.hfCodCobranzadet + "'";
                XmlDetalle = XmlDetalle + " TotalTarjeta = '" + item.TotalTarjeta + "'";
                XmlDetalle = XmlDetalle + " CodMoneda = '" + item.CodMoneda + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            objOperacion.F_EdicionComisionTarjeta(objEntidad);
