<%@ Page Title="Percepciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"    CodeBehind="RegistroPercepciones.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroPercepciones" %>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 0px;">
                                          ...
                                          <td style="display: none">
                                            <asp:TextBox ID="txtResponsable" runat="server" Width="367px" Font-Names="Arial"
            ...
            <div id="div_grvFactura" style="padding-top: 1px;">
                <asp:GridView ID="grvFactura" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Percepcion" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
        ...
        <div id="tabConsulta">
            <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                            ...
                            <td style="font-weight: bold;">
                                <asp:CheckBox ID="chkCliente" runat="server" Text="Proveedor" />
                            </td>
                            <td>
            ...
            <div style="padding-top: 5px;" id="div_consulta">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    Width="960px" OnRowDataBound="grvConsulta_RowDataBound">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR PERCEPCION" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
            <%--            <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgImprimir" ImageUrl="~/Asset/images/pdf.png"
                                    ToolTip="PDF" OnClientClick="F_Imprimir(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <div id="div_grvConsultaFactura">
                            <asp:GridView ID="grvConsultaFactura" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Percepcion">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtMontoObligacion" Text='<%# Bind("MontoObligacion") %>'
                                                Width="55px" Font-Bold="true" Style="text-align: right;" Font-Names="Arial" Enabled="True"
