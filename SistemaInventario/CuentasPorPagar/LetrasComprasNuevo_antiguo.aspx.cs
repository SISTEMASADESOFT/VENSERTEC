...
{
    public partial class LetrasComprasNuevo_antiguo : System.Web.UI.Page
    {
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            grvConsulta.DataSource = objOperacion.F_NotaIngresoSalidaCab_Letras(objEntidad);
            grvConsulta.DataBind();
        }
