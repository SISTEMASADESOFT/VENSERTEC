...
--%>
                        ...
                        <tr>
                                        <td  style="font-weight: bold;display: none">
                                            <div id="div_Entregado" style="display: none">
                                        ...
                                        <td style="padding-left: 15px;display: none">
                                            <div id="div_Recibido" style="display: none">
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                           <td  style="font-weight: bold;display: none">
                                ...
                                <td>
                                    <asp:TextBox ID="txtProveedorConsulta" runat="server" Width="300" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                        </tr>
                        </table>
