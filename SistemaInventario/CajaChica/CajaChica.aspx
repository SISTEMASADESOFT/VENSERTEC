...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server" >
                        ...
                        <Columns>
                         ...
                         <asp:TemplateField ItemStyle-Width="20px">
                            ...
                            <asp:TemplateField HeaderText="Liquidacion" ItemStyle-Width="50px">
                             ...
                             <asp:BoundField DataField="SOLES" HeaderText="SOLES CAJA">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                              <asp:BoundField DataField="SOLESDEPOSITO" HeaderText="SOLES DEPOSITO">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="NROSOLES" HeaderText="NRO OP SOLES">
                             ...
                             <asp:BoundField DataField="DOLARES" HeaderText="DOLARES">
                                ...
                                <ItemStyle HorizontalAlign="Right" />
                                   ...
                                   <asp:BoundField DataField="DOLARESDEPOSITO" HeaderText="DOLARES DEPOSITO">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>     
    ...
    <div id="divLiquidacion" style="display: none;">
         <div class="ui-jqdialog-content">
                     ...
                     <asp:GridView ID="grvLiquidacion" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SALDO SOLES">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblSaldoSoles" Text='<%# Bind("EFECTIVOSOLES") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="SALDO DOLARES">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblSaldoDolares" Text='<%# Bind("EFECTIVODOLARES") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="APLICAR S/.">
                                        ...
                                        <asp:TextBox runat="server" ID="txtTotalSoles" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo tprecio" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("SaldoSoles") %>'
                                                     ReadOnly=true></asp:TextBox><%--onblur="F_ActualizarTotalSoles(this.id); return false;"--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="APLICAR $">
                                        ...
                                        <asp:TextBox runat="server" ID="txtTotalDolares" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                    CssClass="ccsestilo tprecio" Font-Names="Arial"  ForeColor="Blue" Text='<%# Bind("SaldoDolares") %>'
                                                     ReadOnly=true></asp:TextBox>  <%--onblur="F_ActualizarTotalDolares(this.id); return false;"--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
            ...
            <tr>
                 ...
                 <td>   
                       <asp:Label runat="server" style="font-size: medium; color: #000000" ID="Label4" Text='EL REDONDEO ES + -  '></asp:Label>
                                <asp:Label runat="server" ID="lblRedondeo" Text=' ' style="font-size: medium; color: #000000"></asp:Label>
             ...
             <table cellpadding="0" cellspacing="0" class="form-inputs">
                <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding-left: 5px; ">
                        <asp:TextBox ID="txtMontoSolesDepositar" runat="server" Width="70px" Font-Names="Arial"
                           CssClass="Derecha" ForeColor="Blue" Font-Bold="True" onblur="F_ValidaMontoDepositoSoles(this.id); return false;"></asp:TextBox>
                    </td>
                </tr>
                </table>
                </div>
            ...
            <tr>
             ...
             <table cellpadding="0" cellspacing="0"  class="form-inputs">
                ...
                <tr>
                    ...
                    <td style="padding-left: 5px; ">
                        <asp:TextBox ID="txtMontoDolaresDepositar" runat="server" Width="70px" Font-Names="Arial"
                           CssClass="Derecha" ForeColor="Blue" Font-Bold="True" onblur="F_ValidaMontoDepositoDolares(this.id); return false;"></asp:TextBox>
                    </td>
                </tr>
                  <tr>
    ...
    <div id="dlgWait" style="background-color: #CCE6FF; text-align: center; display: none;">
     ...
     <input id="hfCodAlmacen" type="hidden" value="0" />
      ...
      <input id="hfMontoSoles" type="hidden" value="0" />
      <input id="hfMontoDolares" type="hidden" value="0" />
</asp:Content>
