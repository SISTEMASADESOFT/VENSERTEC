<%@ Page Title="Comprobante Egreso" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ComprobanteEgreso.aspx.cs" Inherits="SistemaInventario.CajaChica.ComprobanteEgreso" %>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 1px">
                                            <asp:TextBox ID="txtDistrito" runat="server" Width="317px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 10px;">
                                            <asp:TextBox ID="txtTotal" runat="server" Width="90px" Font-Names="Arial" Font-Bold="True"
                                                CssClass="Derecha" ForeColor="Blue" Text="0.00"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtOperacion" runat="server" Width="140px" Font-Names="Arial" Font-Bold="True"
                        ...
                        <tbody>
                            <tr>
                              <td style="font-weight: bold">
                                ...
                                <td>
                                    <asp:CheckBox ID="chkNumero" runat="server" Text="Num" Font-Bold="True" />
                                </td>
                                <td>
                                ...
                                <td style="font-weight: bold; display: none">
                                 ...
                                 <td style="font-weight: bold; display: none">
                                                         ...
                                                         <td>
                                    <asp:CheckBox ID="chkCliente" runat="server" Text="Pro" Font-Bold="True" />
                                </td>
                                <td>
                                    <asp:TextBox ID="txtProveedorConsulta" runat="server" Width="250" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                           <td>
                                    <asp:CheckBox ID="chkfactura" runat="server" Text="Fac" Font-Bold="True" />
                                </td>
                                <td>
