                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtCliente" runat="server" Width="421px" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="421px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold;">
                                            Caja
                ...
                <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" Visible="false">
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblID" Text='<%# Bind("CodDetalle") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
