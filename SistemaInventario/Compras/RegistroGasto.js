...
var CodigoMenu = 3000; var CodigoInterno = 5;
...
//            }
    ...
    $('#MainContent_txtNoAfecto').css('background', '#FFFFE0');
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoDocumento']",function () {
     F_Documentos($("#MainContent_ddlTipoDocumento").val());
} );
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        $('#MainContent_ddlClasificacion').val(1);
                        $('#MainContent_ddlTipoDocumento').val(1);
                        $('#MainContent_ddlMoneda').val(1);
                        $('#MainContent_ddlFormaPago').val(1);
                        $('#MainContent_txtVencimiento').val($('#MainContent_txtEmision').val());
...
function F_Documentos(CodDocumento) {
 var arg;
    try 
    {
     switch (CodDocumento)
...
function F_ValidarGrabarDocumento(){
    ...
    try 
        ...
        if ($(Cuerpo + 'txtPeriodo').val()=='')
         ...
         if ($(Cuerpo + 'ddlTipoDocumento').val()!=2 & $(Cuerpo + 'ddlTipoDocumento').val()!=12)
         {
  ...
  try 
        ...
        var Contenedor = '#MainContent_';
                ...
                var objParams = {
                                        ...
                                        Filtro_NoAfecto: $(Contenedor + 'txtNoAfecto').val(),
...
function F_Nuevo(){
       ...
       $('#MainContent_txtNoAfecto').val('0.00');
       $('#MainContent_txtSubTotal').val('0.00');
       $('#MainContent_txtIgv').val('0.00');
       $('#MainContent_txtTotal').val('0.00');
       $('#MainContent_txtNoAfecto').val('0.00');
...
function F_AnularRegistro(Fila) {
 ...
 try 
    ...
    if(confirm("Esta seguro de anular la FAC/BOL : " + $(lblnumero_grilla).text() + "\n" + "Del Proveedor : " +  $(lblcliente_grilla).text())==false)
    return false;
     var chkNumero='0';
              var chkFecha='0';
              var chkCliente='0';
