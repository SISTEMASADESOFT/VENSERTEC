<%@ Page Title="Compras Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaCompraLubriservicios.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompraLubriservicios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompraLubriservicios.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold; padding-left: 79px;">
                                            INGRESO
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtGuia" runat="server" Width="524px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <div id="div_CajaFisica" style="padding-left:25px">
                                          ...
                                          <td style="display:none">
                                            <asp:CheckBox runat="server" ID="ChkMotorizado" Text="Motorizado"  Font-Bold="True" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div id="div_CondicionPago">
                                        <asp:DropDownList ID="ddlCondicionPago" runat="server" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True" Width="110">
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" Visible="true">
                         ...
                         <asp:TemplateField HeaderText="" Visible="true">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="~/Asset/images/btnEdit.gif" ToolTip="Editar Factura"
                                    OnClientClick="F_EditarRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                       ...
                       <%-- <asp:TemplateField HeaderText="O">
                        ...
                        <asp:TemplateField HeaderText="Numero">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfMotorizado" runat="server" Value='<%# Bind("Motorizado") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                       ...
                       <%--     <td style="padding-left: 5px; font-weight: bold">
                            ...
                            <td style="font-weight: bold;">
                                <div>
                                    <asp:Label ID="Label3" runat="server" Text="Compra" Font-Bold="True"></asp:Label>
                                </div>
                            </td>
                            <td style="font-weight: bold;">
                ...
                <Columns>
                     ...
                     <asp:TemplateField HeaderText="Codigo">
                        ...
                        <ItemTemplate>
                               ...
                               <asp:Label runat="server" ID="hlkCodigo" Text='<%# Bind("CodigoProducto") %>' CssClass="detallesart"></asp:Label>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                       ...
                                       <td style="font-weight: bold">
                                        ...
                                        <td>
                                            <asp:TextBox Style="width: 80px;  color: blue; font-family: Arial;
                                                font-weight: bold; background: rgb(255, 255, 224);" ID="txtPrecioDisplay" runat="server"
                                                Font-Size="16"></asp:TextBox>
                                            <asp:DropDownList ID="ddlPrecio" Style="width: 100px;display:none;" runat="server" Font-Size="16">
