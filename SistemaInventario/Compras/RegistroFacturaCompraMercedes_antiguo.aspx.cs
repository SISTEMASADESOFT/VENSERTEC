...
{
    public partial class RegistroFacturaCompraMercedes_antiguo : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref CodDireccion, ref CodDepartamento, ref CodProvincia, ref CodDistrito, ref Distrito);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objOperacion.F_NotaIngresoSalidaCab_Insert_Mercedes(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_Mercedes(objEntidad);
