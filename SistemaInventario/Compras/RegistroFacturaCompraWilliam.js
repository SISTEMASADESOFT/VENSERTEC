var AppSession = "../Compras/RegistroFacturaCompraWilliam.aspx";
...
//              
    ...
    $('#MainContent_ddlCondicionPago').css('background', '#FFFFE0');
        ...
        if ($('#MainContent_chkNotaPedido').is(':checked'))
            ...
            if ($('#MainContent_chkConIgvMaestro').is(':checked'))
             ...
             tasaigv=1;
                        ...
                        Precio: ($('#MainContent_txtPrecioDisplay').val()/$('#MainContent_txtCantidad').val())  ,
...
//                var tasaigv=parseFloat( $("#MainContent_ddlIgv option:selected").text()) + parseFloat(1);
                ...
                if (str_resultado_operacion == "1") 
                {
                    ...
                    F_Update_Division_HTML('div_grvDetalleArticulo', result.split('~')[4]);
                        $('#lblgrilladetalle').text(F_Numerar_Grilla("grvDetalleArticulo", 'lblproducto'));   
                     $('#MainContent_txtCantidad').val('');
                            $('#MainContent_txtDsct').val('');
                            $('#MainContent_txtPrecioDisplay').val('');
                            $('#MainContent_txtCantidad').val('');
...
function F_GrabarDocumento(){
  ...
  try 
        ...
        Proveedor = $('#MainContent_txtProveedor').val();
              var FlagMotorizado = 0; if ($('#MainContent_ChkMotorizado').is(':checked')) {FlagMotorizado = 1; };
        if ( Index ==-1 ) {} else {
        ...
        if (NroRuc.length == 8) NroRuc = '';
                ...
                var objParams = {
                                        ...
                                        Filtro_Motorizado: FlagMotorizado
                               };
...
function F_Nuevo(){
       ...
       $('#MainContent_ChkMotorizado').prop('checked',false);
       $('#hfCodFacturaAnterior').val('0');
       ...
       try 
        {
              ...
              var objParams = {                                     
                                 ...
                                 Filtro_FormaPago: $('#MainContent_ddlCondicionPago  option:selected' ).text(),                                       
                               };
...
//                        PRUEBA
                    ...
                    $('#lblTotalDolares').text(TOTALDOLARES.toFixed(2));  
                        ...
                        $('#lblcantidadconsulta').text(F_Numerar_Grilla("grvConsulta", 'lblnumero'));   
 ...
 try 
        {
                ...
                $('#MainContent_grvDetalleOC .chkDelete :checkbox').each(function () {
                    chkSi = '#' + this.id;
                    lblCodDetalle = chkSi.replace('chkEliminar', 'hfCoddetalle');
 ...
 try 
        {
            ...
            var lblcoddetalle = txtCantidad.replace('txtCantidad', 'hfCoddetalle');
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        var NombreArchivo = 'rptFacturaCompra.rpt';
