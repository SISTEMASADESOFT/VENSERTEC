<%@ Page Title="Nota Pedido" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NotaPedido.aspx.cs" Inherits="SistemaInventario.Compras.NotaPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNumeroConsulta" runat="server" Width="75" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkRango" runat="server" Text="Fecha" Checked="True" Font-Bold="True" />
                    </td>
                    <td>
                        <asp:TextBox ID="txtDesde" runat="server" Width="55" Font-Names="Arial" CssClass="Jq-ui-dtp"
                            ReadOnly="True" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="txtHasta" runat="server" Width="55" Font-Names="Arial" CssClass="Jq-ui-dtp"
                            ReadOnly="True" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtClienteConsulta" runat="server" Width="460" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
            </table>
    ...
    <div id="div_consulta" style="padding-top: 5px;">
        <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
            CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="990px"
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/pdf.png" ToolTip="Ver PDF"
                            OnClientClick="MostrarReporte(this); return false;" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
