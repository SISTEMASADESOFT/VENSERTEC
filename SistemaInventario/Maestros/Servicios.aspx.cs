    ...
    public partial class Servicios : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlservicio, ref ddlservicioEdicion, ref Detraccion);
            ...
            str_resultado =
                ...
                str_ddl_Servicios_html + "~" + //2
                str_ddl_ServiciosEdicion_html + "~" + //3
                Detraccion; //4

            return str_resultado;
        }

        public void P_Controles_Inicializar(Hashtable objTablaFiltro,ref DropDownList ddl_comboServicio, ref DropDownList ddl_comboServicioedicion, ref Decimal Detraccion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodMaestroDetracciones", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodDetraccion = Convert.ToInt32(objTablaFiltro["Filtro_CodDetraccion"]);
          
            objOperacion = new LGProductosCN();

            objOperacion.F_LGProductos_Servicios_Insert(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_LGProductos_ListarServicios(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_LGProductos_Eliminar_Servicios(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodDetraccion = Convert.ToInt32(objTablaFiltro["Filtro_Servicio"]);

            objOperacion = new LGProductosCN();

            objOperacion.F_LGProductos_Servicios_Update(objEntidad);
