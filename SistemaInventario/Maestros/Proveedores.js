...
var CodigoMenu = 1000; var CodigoInterno = 2;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnAgregarDireccionMultiple').click(function () {
        if (F_PermisoOpcion(CodigoMenu, '222001', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_FlagCliente: FlagCliente,
...
function F_EditarRegistroDireccion(Fila) {
    if (F_PermisoOpcion(CodigoMenu, '222002', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
...
function F_EliminarDireccion(Fila) {
    if (F_PermisoOpcion(CodigoMenu, '222003', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
