var AppSession = "../Maestros/TipoCambioWilliam.aspx";
var CodigoMenu = 1000; var CodigoInterno = 4;
...
$('#MainContent_btnBuscar').click(function () {
    ...
    $('#MainContent_btnEdicion').click(function () {
        ...
        try {
            ...
            if (confirm("ESTA SEGURO ACTUALIZAR EL TIPO DE CAMBIO"))
                F_EdicionRegistro();
            //                F_Nuevo();
            //            }
            return false;
    ...
    $('#MainContent_txtParaleloCompra').css('background', '#FFFFE0');

    $('#MainContent_txtParaleloCompraEdicion').css('background', '#FFFFE0');
...
function F_ValidarGrabarDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtParalelo').val() == '')
            Cadena = Cadena + '<p></p>' + 'Paralelo Venta';

//        if ($(Cuerpo + 'txtParaleloCompra').val() == '')
//            Cadena = Cadena + '<p></p>' + 'Paralelo Compra';
...
//        if (($(Cuerpo + 'txtParaleloCompra').val() != '' & $(Cuerpo + 'txtParalelo').val() != '') && ($(Cuerpo + 'txtParaleloCompra').val() > $(Cuerpo + 'txtParalelo').val()))
//            Cadena = Cadena + '<p></p>' + 'La Compra no puede ser mayor que la venta';
...
//        if (($(Cuerpo + 'txtParaleloCompraEdicion').val() != '' & $(Cuerpo + 'txtParaleloEdicion').val() != '') && ($(Cuerpo + 'txtParaleloCompraEdicion').val() > $(Cuerpo + 'txtParaleloEdicion').val()))
//            Cadena = Cadena + '<p></p>' + 'La Compra no puede ser mayor que la venta';
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_ParaleloCompra: $(Contenedor + 'txtCompraSunat').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_mensaje_operacion == "Se grabo correctamente") {
                ...
                $('#MainContent_txtParaleloCompra').val('');
                F_Update_Division_HTML('div_grvConsultaArticulo', result.split('~')[2]);
                alertify.log(str_mensaje_operacion);
...
//        var lblParaleloCompra_grilla = '#' + imgID.replace('imgEditarRegistro', 'lblParaleloCompra');
...
//        $(Cuerpo + 'txtParaleloCompraEdicion').val($(lblParaleloCompra_grilla).text());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_ParaleloCompra: $(Contenedor + 'txtCompraSunatEdicion').val(),
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se grabo correctamente') {
                    ...
                    $(Contenedor + 'txtParaleloCompraEdicion').val('0');
