...
var CodigoMenu = 1000; var CodigoInterno = 1;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnAgregarDireccionMultiple').click(function () {
        if (F_PermisoOpcion(CodigoMenu, '111001', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
             ...
             $('#div_DireccionMultipleAdd').dialog('open');
   ...
   $('#MainContent_btnGrabarResponsable').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
    if (F_PermisoOpcion(CodigoMenu, '112001', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            if (!F_ValidarGrabarResponsable())
                return false;

            if (confirm("ESTA SEGURO DE GRABAR EL RESPONSABLE"))
                F_GrabarResponsable();
    ...
    $('#MainContent_btnEditarResponsable').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
        try {
            if (!F_ValidarEditarResponsable())
                return false;

            if (confirm("ESTA SEGURO DE ACTUALIZAR EL RESPONSABLE"))
                F_EdicionResponsable();
   ...
   $('#MainContent_btnGrabarContacto').click(function () {
    ...
    $('#MainContent_txtCorreoResponsable1').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsable2').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsable3').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsable4').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsable5').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsable6').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtEmailEdicionMultiple6').css('background', '#FFFFE0');
       ...
       $('#MainContent_txtCorreoResponsableEdicion1').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsableEdicion2').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsableEdicion3').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsableEdicion4').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsableEdicion5').css('background', '#FFFFE0');

    $('#MainContent_txtCorreoResponsableEdicion6').css('background', '#FFFFE0');

    $('#MainContent_txtClienteResponsable').css('background', '#FFFFE0');

    $('#MainContent_txtClienteDireccion').css('background', '#FFFFE0');

    $('#MainContent_txtResponsableDNI').css('background', '#FFFFE0');

    $('#MainContent_txtResponsableDNIEdicion').css('background', '#FFFFE0');

    $("#MainContent_txtResponsableDNI").ForceNumericOnly();
    
    $("#MainContent_txtResponsableDNIEdicion").ForceNumericOnly();

    $('#MainContent_txtClienteResponsable').css('background', '#FFFFE0');

    $('#MainContent_txtResponsableEdicion').css('background', '#FFFFE0');
    ...
    $("#MainContent_txtDescripcionConsulta").blur(function () {
        ...
        $("#div_DireccionMultipleAdd").dialog({
            resizable: false,
            modal: true,
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_EstadoResponsableEdicion', result.split('~')[4]);
                        F_Update_Division_HTML('div_EstadoResponsable', result.split('~')[5]);
                        $('#MainContent_ddlTipoCliente').val('2');
                        $('#ddlEstadoResponsableEdicion').val('1');
                        $('#ddlEstadoResponsable').val('1');
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtNombres').prop('disabled', true);
    $(Contenedor + 'chkProveedor').prop('checked', false);
    $(Contenedor + 'chkRetencion').prop('checked', false);
    $(Contenedor + 'txtNroRuc').focus();
    return false;
}
    ...
    try {
        ...
        F_Buscar_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                $('#lblGrillaConsulta').text(F_Numerar_Grilla("grvConsulta", 'lblDocumento'));
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        $('#MainContent_ddlTipoCliente_Edicion').prop('disabled', true);
        ...
        if($(hfCodRetencion_grilla).val()==1)
        {
    $(Cuerpo + 'chkRetencionEdicion').prop('checked', true);
        }else{
    $(Cuerpo + 'chkRetencionEdicion').prop('checked', false);
        }
        ...
        F_GrabarDireccion_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente') {
                    ...
                    $('#div_DireccionMultipleAdd').dialog('close');
                }
                else
                    alertify.log(result.split('~')[1]);
...
function F_EditarRegistroDireccion(Fila) {
    if (F_PermisoOpcion(CodigoMenu, '111002', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
...
function F_ElegirPrincipalDireccion(Fila) {
    ...
    try {
        ...
        {
            alertify.log('LAS DIRECCIONES PRINCPALES DEBEN ESTAR ACTIVAS');
            return false;
        }
...
function F_EliminarDireccion(Fila) {
    if (F_PermisoOpcion(CodigoMenu, '111003', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
...
function F_ValidaDni() {
if (!F_SesionRedireccionar(AppSession)) return false;
    if ($('#MainContent_txtNroDni').val().length > 0)
    {

        if (isNaN($('#MainContent_txtNroDni').val()) | !ValidarRuc($('#MainContent_txtNroDni').val()))
        {
            $('#MainContent_txtNroDni').val('');
            $('#MainContent_txtNroDni').focus();
            alertify.log('ERROR EN DNI');
            return false;
        }
...
//        else
        {
            //DNI
            if ($('#MainContent_txtNroDni').val().length == 11)
            {
                alertify.log('NRO. DNI INVALIDO'); 
                $('#MainContent_txtNroDni').val('');
                $('#MainContent_txtNroDni').focus();
                return false;
            }
    ...
    MostrarEspera(true);
          if (API == "") {  
            $.ajax({
                ...
                try {
                 // condiciona joel:si en la base de datos no se encuentra ninguna condicion de ruc se manda para la apisunat
                     if (data.length!=0) {
                        if (data[0].split(',')[0] != '0')
                            {
                                alertify.log('EL CLIENTE YA EXISTE');
                                $('#MainContent_txtNroRuc').val('');
                                $('#MainContent_txtRazonSocial').val('');
                ...
                catch (x) { alertify.log('EL CLIENTE NO HA SIDO ENCONTRADO'); }
                MostrarEspera(false);
            },
...
function F_Responsables(Fila) {
        
        var imgID = Fila.id;
        var lblcodigo_grilla = '#' + imgID.replace('imgResponsables', 'hfCodigo');
        var lblcliente_grilla = '#' + imgID.replace('imgResponsables', 'lblCliente');
        var Cuerpo = '#MainContent_';

        $(Cuerpo + 'ddlEstadoResponsable').val('1');
        ...
        F_Responsables_NET(arg, function (result) {
            MostrarEspera(false);
            ...
            if (str_resultado_operacion == "1") {
                ...
                F_Update_Division_HTML('div_ResponsablesGrid', result.split('~')[2]);
                $('#hfCodCtaCte').val($(lblcodigo_grilla).text());
                $(Cuerpo + 'txtResponsable').val('');
				$(Cuerpo + 'txtCorreoResponsable').val('');
				$(Cuerpo + 'txtResponsableDNI').val('');
                $(Cuerpo + 'txtClienteResponsable').val($(lblcliente_grilla).text());
...
function F_ValidarGrabarResponsable() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtCorreoResponsable').val() == '')
            Cadena = Cadena + '<p></p>' + 'Correo';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable1').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 1';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable2').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 2';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable3').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 3';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable4').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 4';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable5').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 5';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsable6').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 6';
...
function F_GrabarResponsable() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Dni: $(Contenedor + 'txtResponsableDNI').val(),
            Filtro_CodEstado: $(Contenedor + 'ddlEstadoResponsable').val(),
            Filtro_Correo1: $(Contenedor + 'txtCorreoResponsable1').val(),
            Filtro_Correo2: $(Contenedor + 'txtCorreoResponsable2').val(),
            Filtro_Correo3: $(Contenedor + 'txtCorreoResponsable3').val(),
            Filtro_Correo4: $(Contenedor + 'txtCorreoResponsable4').val(),
            Filtro_Correo5: $(Contenedor + 'txtCorreoResponsable5').val(),
            Filtro_Correo6: $(Contenedor + 'txtCorreoResponsable6').val(),
        };


        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_GrabarResponsable_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'SE GRABO CORRECTAMENTE') {
                    ...
                    $(Contenedor + 'txtResponsableDNI').val('');
                    $(Contenedor + 'txtCorreoResponsable1').val('');
                    $(Contenedor + 'txtCorreoResponsable2').val('');
                    $(Contenedor + 'txtCorreoResponsable3').val('');
                    $(Contenedor + 'txtCorreoResponsable4').val('');
                    $(Contenedor + 'txtCorreoResponsable5').val('');
                    $(Contenedor + 'txtCorreoResponsable6').val('');
                }
                else
                    alertify.log(result.split('~')[1]);
...
function F_ValidarEditarResponsable() {
    ...
    try {
      ...
      if ($(Cuerpo + 'txtResponsableEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Responsable';
		
        if ($(Cuerpo + 'txtCorreoResponsableEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Correo';


        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion1').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 1';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion2').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 2';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion3').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 3';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion4').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 4';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion5').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 5';

        if (!F_ValidarCorreo($(Cuerpo + 'txtCorreoResponsableEdicion6').val()))
            Cadena = Cadena + '<p></p>' + 'Correo 6';
...
function F_EditarResponsables(Fila) {
    if (F_PermisoOpcion(CodigoMenu, '112002', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
        var lblCodResponsable = '#' + imgID.replace('imgEditarResponsable', 'lblCodResponsable');
        var lblDatosPersonales = '#' + imgID.replace('imgEditarResponsable', 'lblDatosPersonales');
        var lblDni = '#' + imgID.replace('imgEditarResponsable', 'lblDNI');
        var lblCorreo1 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo1');
        var lblCorreo2 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo2');
        var lblCorreo3 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo3');
        var lblCorreo4 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo4');
        var lblCorreo5 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo5');
        var lblCorreo6 = '#' + imgID.replace('imgEditarResponsable', 'lblCorreo6');
        var hfCodCtaCte = '#' + imgID.replace('imgEditarResponsable', 'hfCodCtaCte');
        var hfCodEstado = '#' + imgID.replace('imgEditarResponsable', 'hfCodEstado');

        var Cuerpo = '#MainContent_';

        $('#hfCodCtaCte').val($(hfCodCtaCte).val());
        $('#hfCodResponsable').val($(lblCodResponsable).text());
        $(Cuerpo + 'txtResponsableEdicion').val($(lblDatosPersonales).text());
        $(Cuerpo + 'txtResponsableDNIEdicion').val($(lblDni).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion1').val($(lblCorreo1).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion2').val($(lblCorreo2).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion3').val($(lblCorreo3).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion4').val($(lblCorreo4).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion5').val($(lblCorreo5).text());
        $(Cuerpo + 'txtCorreoResponsableEdicion6').val($(lblCorreo6).text());
        $(Cuerpo + 'ddlEstadoResponsableEdicion').val($(hfCodEstado).val());

        $("#div_ResponsablesEdicion").dialog({
            resizable: false,
            modal: true,
            title: "Edicion de Responsable",
            title_html: true,
            height: 350,
            width: 650,
            autoOpen: false
        ...
        $('#div_ResponsablesEdicion').dialog('open');
...
function F_EdicionResponsable() {
    ...
    try {
        ...
        var objParams = {
            Filtro_CodCtaCte: $('#hfCodCtaCte').val(),
            Filtro_CodResponsable: $('#hfCodResponsable').val(),
            Filtro_DatosPersonales: $('#MainContent_txtResponsableEdicion').val(),
            Filtro_Dni: $('#MainContent_txtResponsableDNIEdicion').val(),
            Filtro_Correo1: $('#MainContent_txtCorreoResponsableEdicion1').val(),
            Filtro_Correo2: $('#MainContent_txtCorreoResponsableEdicion2').val(),
            Filtro_Correo3: $('#MainContent_txtCorreoResponsableEdicion3').val(),
            Filtro_Correo4: $('#MainContent_txtCorreoResponsableEdicion4').val(),
            Filtro_Correo5: $('#MainContent_txtCorreoResponsableEdicion5').val(),
            Filtro_Correo6: $('#MainContent_txtCorreoResponsableEdicion6').val(),
            Filtro_CodEstado: $('#MainContent_ddlEstadoResponsableEdicion').val(),
        };


        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_ActualizarResponsables_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'SE ACTUALIZO CORRECTAMENTE') {
                    ...
                    $(Contenedor + 'txtResponsable').val('');
                    $(Contenedor + 'txtResponsableDNI').val('');
                    $(Contenedor + 'txtCorreoResponsable').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion1').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion2').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion3').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion4').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion5').val('');
                    $(Contenedor + 'txtCorreoResponsableEdicion6').val('');
                    $('#div_ResponsablesEdicion').dialog('close');
...
function F_ValidaResponsable() {
if (!F_SesionRedireccionar(AppSession)) return false;
    if ($('#MainContent_txtResponsableDNI').val().length > 0)
    {

        if (isNaN($('#MainContent_txtResponsableDNI').val()) | !ValidarRuc($('#MainContent_txtResponsableDNI').val()))
        {
            $('#MainContent_txtResponsableDNI').val('');
            $('#MainContent_txtResponsableDNI').focus();
            alertify.log('ERROR EN RUC');
            return false;
        }
...
//        else
        {
            //DNI
            if ($('#MainContent_txtResponsableDNI').val().length == 8)
            {
//                alertify.log('NRO. RUC INVALIDO'); 
//                $('#MainContent_txtResponsableDNI').val('');
//                    $('#MainContent_txtResponsableDNI').focus();
            ...
            {
                Ruc = '';
                if ($('#MainContent_txtResponsableDNI').val().length == 11)
                {
                    $('#MainContent_txtCliente').prop('disabled', false);
                    $('#MainContent_txtApePaterno').prop('disabled', true);
                    $('#MainContent_txtApePaterno').val('');
                    ...
                    F_BuscarDatosPorRucDni($('#MainContent_txtResponsableDNI').val());
                }
                else
                {
                    alertify.log('NRO. RUC INVALIDO'); 
    ...
    {
        if ($('#MainContent_txtResponsableDNIq').val() != $('#hfNroRuc').val())
        {
            //F_LimpiarCampos();
        }
    }
...
function F_ValidaResponsableEditar() {
if (!F_SesionRedireccionar(AppSession)) return false;
    if ($('#MainContent_txtResponsableDNIEdicion').val().length > 0)
    {

        if (isNaN($('#MainContent_txtResponsableDNIEdicion').val()) | !ValidarRuc($('#MainContent_txtResponsableDNIEdicion').val()))
        {
            $('#MainContent_txtResponsableDNIEdicion').val('');
            $('#MainContent_txtResponsableDNIEdicion').focus();
            alertify.log('ERROR EN RUC');
            return false;
        }
...
//        else
        {
            //DNI
            if ($('#MainContent_txtResponsableDNIEdicion').val().length == 8)
            {
//                alertify.log('NRO. RUC INVALIDO'); 
//                $('#MainContent_txtResponsableDNI').val('');
//                    $('#MainContent_txtResponsableDNI').focus();
            ...
            {
                Ruc = '';
                if ($('#MainContent_txtResponsableDNIEdicion').val().length == 11)
                {
                    $('#MainContent_txtCliente').prop('disabled', false);
                    $('#MainContent_txtApePaterno').prop('disabled', true);
                    $('#MainContent_txtApePaterno').val('');
...
//                    $('#MainContent_txtCliente').focus();
                    ...
                    F_BuscarDatosPorRucDni($('#MainContent_txtResponsableDNIEdicion').val());
                }
                else
                {
                    alertify.log('NRO. RUC INVALIDO'); 
