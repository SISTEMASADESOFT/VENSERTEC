<%@ Page Title="Familias" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Familias.aspx.cs" Inherits="SistemaInventario.Maestros.Familias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Familias.js" charset="UTF-8"></script>
                     ...
                     <div id="divTabs">
                        ...
                        <div id="tabRegistro">
                             ...
                             <asp:TextBox ID="txtDescripcion" runat="server"  Width="350px" Font-Names="Arial" ForeColor="Blue"  Font-Bold="True" ></asp:TextBox>
                                 ...
                                 <td>
                               <div id="div_Estado">
                                         <asp:DropDownList ID="ddlEstado" runat="server" Font-Names="Arial"  ForeColor="Blue" Font-Bold="True" Width="354"> 
                                          </asp:DropDownList>
                                     </div>  
                             </td>
                        ...
                        <div id="tabConsulta">
                            ...
                            <div id="div_consulta" style="padding-top:5px;" >
                                                ...
                                                <Columns>                                                 
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" id="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png" ToolTip="Eliminar Familia" OnClientClick="F_EliminarRegistro(this); return false;" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" id="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif" ToolTip="EDITAR EMPLEADO" OnClientClick="F_EditarRegistro(this); return false;" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="ID" >
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblIDFamilia" Text='<%# Bind("IDFamilia") %>'></asp:Label>
                                                           ...
                                                           <ItemStyle HorizontalAlign="Right" />
                                                           <ItemTemplate>
                                                             <asp:Label runat="server" ID="lblCodFamilia" Text='<%# Bind("CodFamilia") %>'></asp:Label>
                                                           </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                 ...
                                 <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                                        <tr>
                                              ...
                                              Codigo
                                               ...
                                               <td>
                                                <asp:TextBox ID="txtCodFamiliaEdicion" runat="server" Width="50" Font-Names="Arial" ForeColor="Blue"  Font-Bold="True"  ReadOnly="True"></asp:TextBox>
                                             </td>                           
                                           <td  style="font-weight: bold">
                                               Descripcion
                                             </td>
                             ...
                             ESTADO
                               ...
                               <div id="div_EstadoEdicion">
                                         <asp:DropDownList ID="ddlEstadoEdicion" runat="server" Font-Names="Arial"  ForeColor="Blue" Font-Bold="True" Width="403"> 
                                          </asp:DropDownList>
                                     </div>  
                             </td>
                                        </tr>
