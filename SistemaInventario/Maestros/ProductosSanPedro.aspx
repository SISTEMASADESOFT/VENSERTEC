<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductosSanPedro.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosSanPedro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosSanPedro.js" charset="UTF-8"></script>
