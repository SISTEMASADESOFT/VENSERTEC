var AppSession = "../Maestros/Linea.aspx";
var CodigoMenu = 1000; var CodigoInterno = 12;
...
function F_EditarRegistro(Fila) {
    try {
        ...
        var lblCodigoLinea = '#' + imgID.replace('imgEditarRegistro', 'lblCodigoLinea');
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'SE ACTUALIZO CORRECTAMENTE') {
                    ...
                    $(Contenedor + 'txtCodFamiliaEdicion').val('');
