var AppSession = "../Maestros/ActivosFijosWilliam.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_ddlFamilia').val('013');
        ...
        $('#MainContent_grvConsulta .chkSi :checkbox').each(function () {
            ...
            if ($(chkSi).is(':checked')) {
                if ($(txtDscProducto).val() == '')
                    cadena = cadena + "\n" + "Descripcion para el codigo " + $(txtDscProducto).text();

                if ($(txtProducto).val() == '')
                    cadena = cadena + "\n" + "Descripcion para el Producto  " + $(txtProducto).text();

                    if ($(txtMarca).val() == '')
                    cadena = cadena + "\n" + "Descripcion para el Marca  " + $(txtMarca).text();

//                    if ($(txtDescuento).val() == '')
//                    cadena = cadena + "\n" + "Descripcion para el codigo " + $(txtDescuento).text();

                    if ($(txtCosto).val() == '')
                                        cadena = cadena + "\n" + "Falta Costo " + $(txtCosto).text();
                    
                    if ($(txtMargen).val() == '')
                                        cadena = cadena + "\n" + "Falta Costo " + $(txtMargen).text();
