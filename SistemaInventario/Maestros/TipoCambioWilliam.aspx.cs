...
{
    public partial class TipoCambioWilliam : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia()
        {
            ...
            dta_consultaarticulo.Columns.Add("ParaleloCompra", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.ParaleloCompra = Convert.ToDecimal(objTablaFiltro["Filtro_ParaleloCompra"]);
            objEntidad.Fecha = Convert.ToDateTime(objTablaFiltro["Filtro_Fecha"]);
            objOperacion = new TCTipoCambioCN();

            objOperacion.F_TCTipoCambio_Insert_William(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_TCTipoCambio_Listar_William(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TCTipoCambio_Update_William(objEntidad);
