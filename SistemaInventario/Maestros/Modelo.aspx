<%@ Page Title="Modelo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modelo.aspx.cs" Inherits="SistemaInventario.Maestros.Modelo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Modelo.js" charset="UTF-8"></script>
                               ...
                               <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 460px">
                                   ...
                                   <div >  
                                    ...
                                    Linea
                                          ...
                                          <td>
                             <asp:TextBox ID="txtLinea" runat="server"  Width="350px" Font-Names="Arial" ForeColor="Blue"  Font-Bold="True" ></asp:TextBox>
                             </td>
                                     </tr>     
                        ...
                        <div id="tabConsulta">
                            ...
                            <div id="div_consulta" style="padding-top:5px;" >
                                                ...
                                                <Columns>                                                 
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" id="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png" ToolTip="ELIMINAR MODELO" OnClientClick="F_EliminarRegistro(this); return false;" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" id="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif" ToolTip="EDITAR MODELO" OnClientClick="F_EditarRegistro(this); return false;" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                            ...
                            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                 ...
                                 <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                                  <tr>
                                    ...
                                    Linea
                                          ...
                                          <td>
                             <asp:TextBox ID="txtLineaEdicion" runat="server"  Width="250px" Font-Names="Arial" ForeColor="Blue"  Font-Bold="True" ></asp:TextBox>
                             </td>
                                     </tr>  
                                        <tr>
                             ...
                             ESTADO
                               ...
                               <div id="div_EstadoEdicion">
                                         <asp:DropDownList ID="ddlEstadoEdicion" runat="server" Font-Names="Arial"  ForeColor="Blue" Font-Bold="True" Width="253"> 
                                          </asp:DropDownList>
                                     </div>  
                             </td>
                                        </tr>
