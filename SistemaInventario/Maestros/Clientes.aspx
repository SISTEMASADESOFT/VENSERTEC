                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 4px;" colspan='5'>
                                <asp:TextBox ID="txtEmail" runat="server" Width="500px" Font-Names="Arial" Font-Bold="True"
                                    ForeColor="Blue"></asp:TextBox>
                            </td>
                        </tr>
                         <tr>
        ...
        <div id="tabConsulta">
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                   ...
                   <%--     <asp:TemplateField HeaderText="Res" HeaderStyle-Width="10px">
                            <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtResponsableDNI" runat="server" Width="100px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"  onblur="F_ValidaResponsable();"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtResponsableDNIEdicion" runat="server" Width="100px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" onblur="F_ValidaResponsableEditar();"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
