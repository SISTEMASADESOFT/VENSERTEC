...
{
    public partial class ProductosWilliam : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ConsultaHistorialCostos_NET);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            P_Inicializar_GrillaVacia_HistorialCostos();
        }
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblCodigo = (HiddenField)(e.Row.FindControl("hfCodProducto"));
         ...
         public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_Servicios_html = "";
            String str_ddl_ServiciosEdicion_html = "";
            decimal TC = 0;
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlEstado, ref ddlEstadoEdicion, ref ddlservicio, ref ddlservicioEdicion, ref Detraccion);
                ...
                str_ddl_Servicios_html = Mod_Utilitario.F_GetHtmlForControl(ddlservicio);
                str_ddl_ServiciosEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlservicioEdicion);
            ...
            str_resultado =
                ...
                TC.ToString() + "~" + //3
                str_ddl_umcompra_html + "~" + //4
                str_ddl_umventa_html + "~" + //5
                str_ddl_familia_html + "~" + //6
                str_ddl_familiaconsulta_html + "~" + //7
                str_ddl_familiaedicion_html + "~" + //8
                str_ddl_monedaedicion_html + "~" + //9
                str_ddl_umcompraedicion_html + "~" + //10
                str_ddl_umventaedicion_html + "~" + //11
                TC.ToString() + "~" + //12
                str_ddl_estado_html + "~" + //13
                str_ddl_estadoedicion_html + "~" + //14
                str_ddl_Servicios_html + "~" + //15
                str_ddl_ServiciosEdicion_html + "~" + //16
                Detraccion; //17
        ...
        public String F_ConsultaHistorialCostos_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Int32 int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_ConsultaHistorialCostos(obj_parametros, ref grvHistorialCostos);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";

                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialCostos);
            }
            catch (Exception ex)
            {
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_Producto_Auditoria(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_comboestado, ref DropDownList ddl_comboestadoedicion
            , ref DropDownList ddl_comboServicio, ref DropDownList ddl_comboServicioedicion, ref Decimal Detraccion)
        {
            ...
            dta_consulta = objOperacion.F_Servicios_Listar();

            ddl_comboServicio.Items.Clear();

            ddl_comboServicio.DataSource = dta_consulta;
            ddl_comboServicio.DataTextField = "Descripcion";
            ddl_comboServicio.DataValueField = "CodMaestroDetracciones";
            ddl_comboServicio.DataBind();

            ddl_comboServicioedicion.Items.Clear();

            ddl_comboServicioedicion.DataSource = dta_consulta;
            ddl_comboServicioedicion.DataTextField = "Descripcion";
            ddl_comboServicioedicion.DataValueField = "CodMaestroDetracciones";
            ddl_comboServicioedicion.DataBind();

            //detraccion
            
            dta_consulta = null;

            TCTipoCambioCE objEntidad = new TCTipoCambioCE();

            objEntidad.CodEmpresa = Convert.ToInt32(Session["CodEmpresa"]);

            dta_consulta = objOperacion.F_FlagDetraccion_Select(objEntidad);

            if (dta_consulta.Rows.Count > 0)
                Detraccion = Convert.ToDecimal(dta_consulta.Rows[0]["FlagDetraccion"]);
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("MargenOriginal", typeof(string));//
            ...
            dta_consultaarticulo.Columns.Add("DescripcionAuxiliar", typeof(string));//
            ...
            //    {
                    ...
                    //try
                    //{
                    //    if (Convert.ToInt32(dta_consulta.Rows[0]["P_MOSTRAR_MEDIDA_CONSULTA_PRODUCTO"].ToString()) == 0)
                    //        grvConsulta.Columns[11].Visible = false;
                    //}
                    //catch (Exception) { grvConsulta.Columns[11].Visible = false; }

                    //try
                    //{
                    //    //columna UM (8)
                    //    if (Convert.ToInt32(dta_consulta.Rows[0]["P_MOSTRAR_UM_CONSULTAS"].ToString()) == 0)
                    //        grvConsulta.Columns[10].Visible = false;
                    //}
                    //catch (Exception) { }
                    ...
                    //    try
                    //    {
                        //    try { grvConsulta.Columns[9].HeaderText = dta_talmacenes.Rows[1]["P_TITULO_VTAS"].ToString(); }
                        //    catch (Exception) { }
                        //    if (dta_talmacenes.Rows[1]["P_MOSTRAR_VTAS"].ToString() == "0")
                        //    {
                        //        grvConsulta.Columns[9].Visible = false;
                        //    }
                        //}
                        //catch (Exception) { grvConsulta.Columns[9].Visible = false; }

                        //try
                        //{
                        //    try { grvConsulta.Columns[8].HeaderText = dta_talmacenes.Rows[0]["P_TITULO_VTAS"].ToString(); }
                        //    catch (Exception) { }
                        //    if (dta_talmacenes.Rows[0]["P_MOSTRAR_VTAS"].ToString() == "0")
                        //    {
                        //        grvConsulta.Columns[8].Visible = false;
                        //    }
                        //}
                        //catch (Exception) { }
            //        }
        ...
        public void P_Inicializar_GrillaVacia_HistorialCostos()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            dta_consultaarticulo.Columns.Add("Modulo", typeof(string));//
            dta_consultaarticulo.Columns.Add("Proveedor", typeof(string));//
            dta_consultaarticulo.Columns.Add("CostoMercado_ANTERIOR", typeof(string));//
            dta_consultaarticulo.Columns.Add("CostoMercado_NUEVO", typeof(string));//
            dta_consultaarticulo.Columns.Add("CostoProducto_ANTERIOR", typeof(string));//
            dta_consultaarticulo.Columns.Add("CostoProducto_NUEVO", typeof(string));//
            ...
            grvHistorialCostos.DataSource = dta_consultaarticulo;
            grvHistorialCostos.DataBind();
        }
        ...
        public void F_ConsultaHistorialCostos(Hashtable objTablaFiltro, ref GridView gridCostos)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion = new LGProductosCN();
            dtTabla = objOperacion.F_LGProductos_HistorialCostos(objEntidad);

            gridCostos.DataSource = dtTabla;
            gridCostos.DataBind();
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " hfCodProducto          = '" + item.hfCodProducto + "'";
                //XmlDetalle = XmlDetalle + " CodAlterno          = '" + item.txtCodAlterno + "'";
                //XmlDetalle = XmlDetalle + " Pais                = '" + item.txtPais + "'";
                XmlDetalle = XmlDetalle + " CodigoProducto      = '" + item.txtCodigoProducto + "'";
                //XmlDetalle = XmlDetalle + " DescripcionAuxiliar = '" + item.txtDescripcionAuxiliar + "'";
                XmlDetalle = XmlDetalle + " Producto            = '" + item.txtProducto + "'";
                //XmlDetalle = XmlDetalle + " DscProducto2        = '" + item.txtDscProducto2 + "'";
                XmlDetalle = XmlDetalle + " Marca               = '" + item.txtMarca + "'";
                //XmlDetalle = XmlDetalle + " Motor               = '" + item.txtMotor + "'";
                //XmlDetalle = XmlDetalle + " Posicion            = '" + item.txtPosicion + "'";
                //XmlDetalle = XmlDetalle + " Año                 = '" + item.txtAño + "'";
                //XmlDetalle = XmlDetalle + " MEDIDA              = '" + item.txtMEDIDA + "'";
                XmlDetalle = XmlDetalle + " Costo               = '" + item.txtCosto + "'";
                XmlDetalle = XmlDetalle + " Margen              = '" + item.txtMargen + "'";
                XmlDetalle = XmlDetalle + " Descuento           = '" + item.txtDescuento + "'";
                XmlDetalle = XmlDetalle + " Ubicacion           = '" + item.txtUbicacion + "'";
                XmlDetalle = XmlDetalle + " Familia          = '" + item.txtFamilia + "'";
                XmlDetalle = XmlDetalle + " CodFamilia          = '" + item.hfCodFamilia + "'";
                XmlDetalle = XmlDetalle + " CodEstado     = '" + item.CodEstado + "'";
                XmlDetalle = XmlDetalle + " StockMinimo     = '" + item.txtStockMinimo + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.DscProducto2 = Convert.ToString(objTablaFiltro["Filtro_DscProducto2"]);
            objEntidad.DscProductoIngles = Convert.ToString(objTablaFiltro["Filtro_DscProductoIngles"]);
            objEntidad.DescripcionAuxiliar = Convert.ToString(objTablaFiltro["Filtro_DescripcionAuxiliar"]);
            ...
            objEntidad.Aro3 = Convert.ToDecimal(objTablaFiltro["Filtro_Aro"]);
            objEntidad.Medida3 = Convert.ToString(objTablaFiltro["Filtro_Medida"]);
            objEntidad.Seccion = Convert.ToDecimal(objTablaFiltro["Filtro_Seccion"]);
            ...
            objEntidad.Pais = Convert.ToString(objTablaFiltro["Filtro_Pais"]);
            objEntidad.Posicion = Convert.ToString(objTablaFiltro["Filtro_Posicion"]);
            objEntidad.Año = Convert.ToString(objTablaFiltro["Filtro_Año"]);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodFamilia = Convert.ToString(objTablaFiltro["Filtro_CodFamilia"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstadoBusqueda"]);
            objEntidad.Ubicacion = Convert.ToString(objTablaFiltro["Filtro_Ubicacion"]);

            GrillaBuscar.DataSource = objOperacion.F_LGProductos_ListarVentas_Descuento(objEntidad);
            GrillaBuscar.DataBind();
        }
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.DscProducto2 = Convert.ToString(objTablaFiltro["Filtro_DscProducto2Edicion"]);
            objEntidad.DescripcionAuxiliar = Convert.ToString(objTablaFiltro["Filtro_DescripcionAuxiliar"]);
            objEntidad.DscProductoIngles = Convert.ToString(objTablaFiltro["Filtro_DscProductoIngles"]);
            objEntidad.CodTipoProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoProducto"]);
            objEntidad.CodUnidadCompra = Convert.ToInt32(objTablaFiltro["Filtro_CodUnidadCompra"]);
            ...
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidad.StockMinimo = Convert.ToDecimal(objTablaFiltro["Filtro_StockMinimo"]);
            objEntidad.Comentario = Convert.ToString(objTablaFiltro["Filtro_Comentario"]);
            objOperacion = new LGProductosCN();
        ...
        public void P_GrabarDetalle(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_ProductoModelo_Insertar(objEntidad);
