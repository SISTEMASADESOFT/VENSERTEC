<%@ Page Title="Linea" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Linea.aspx.cs" Inherits="SistemaInventario.Maestros.Linea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Linea.js" charset="UTF-8"></script>
                            ...
                            <div id="div_consulta" style="padding-top:5px;" >
                                                ...
                                                <Columns>                                                 
                                                         ...
                                                         <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                                           ...
                                                           <ItemTemplate>
                                                             <asp:Label runat="server" ID="lblCodigoLinea" Text='<%# Bind("CodigoLinea") %>'></asp:Label>
