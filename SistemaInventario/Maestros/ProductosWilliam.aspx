<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductosWilliam.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosWilliam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosWilliam.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo">
        Productos</div>
    <div id="divTabs"  style="width: 1338px">
        <ul>
                         ...
                         <tr style = "display:none;">
                            ...
                            <td style="padding-left: 0px;">
                                         <div id="div_Servicios">
                                                <asp:DropDownList ID="ddlservicio" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="365">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                            </tr>
        ...
        <div id="tabConsulta">
            <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"   style="width: 1000px">
                <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                 ...
                 <%--       <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Marca" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>                                
                                ...
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True"  CssClass="AutoComplete"  onblur="AutocompleteMarca(this.id);"
                        ...
                        <asp:TemplateField HeaderText="STOCK">
                         ...
                         <asp:TemplateField HeaderText="Costo" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>                                
                                ...
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" 
                                Text='<%# Bind("CostoMercado") %>' Enabled="False"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Margen" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="Dsco." HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="Ubicacion" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Dolares" Visible=false>
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Soles" Visible=false>
                        ...
                        <asp:BoundField DataField="Moneda" HeaderText="Mon">
                         ...
                         <asp:TemplateField HeaderText="Stock Minimo" HeaderStyle-HorizontalAlign="Left">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                
                                  <asp:TextBox runat="server" ID="txtStockMinimoConsulta" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" 
                                Text='<%# Bind("StockMinimo") %>' Enabled="False"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                ...
                <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <td style="padding-left: 19px;">
                                              <asp:TextBox ID="txtStockMinimoEdicion" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                  CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                        </td>
                  ...
                  <tr>
                    ...
                    <td colspan='5' style="padding-left: 4px;">
                        <asp:TextBox ID="txtComentarioEdicion" runat="server" Width="525px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                  <tr style = "display:none;">
                            ...
                            <tr>
                            <td style="padding-left: 0px;">
                                         <div id="div_ServiciosEdicion">
                                                <asp:DropDownList ID="ddlservicioEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="368">
                                                </asp:DropDownList>
                                           </div> 
                                        </td>
                            </tr>
                    ...
                    <div id="div_grvHistorialCostos" style="padding-top: 5px;">
                        <asp:GridView ID="grvHistorialCostos" runat="server" AutoGenerateColumns="False"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:BoundField DataField="Modulo" HeaderText="Comentario" HeaderStyle-Width="170px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="FechaDocumento" HeaderText="Emision" HeaderStyle-Width="50px" Visible="false">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Proveedor" HeaderText="Proveedor" HeaderStyle-Width="250px" Visible="false">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                      <%--          <asp:BoundField DataField="CostoProducto_ANTERIOR" HeaderText="Costo Anterior" HeaderStyle-Width="40px"
                                    >
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CostoProducto_NUEVO" HeaderText="Costo" HeaderStyle-Width="60px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>--%>
