<%@ Page Title="Activos Fijos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ActivosFijos.aspx.cs" Inherits="SistemaInventario.Maestros.ActivosFijos" %>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 0px; font-weight: bold; padding-left:22px">
                                            Familia
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="502px" Font-Names="Arial"
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 12px;">
                                            <asp:TextBox ID="txtMedida" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            Seccion
                                        ...
                                        <td style="padding-left: 17px;">
                                            <asp:TextBox ID="txtSeccion" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        ...
                                        <td style="padding-left: 17px;">
                                            <asp:TextBox ID="txtFactor" runat="server" Width="75px" Font-Names="Arial" Text="0.00"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtPrecio1" runat="server" Width="75px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td style="font-weight: bold">
                                            Moneda
            ...
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                ...
                <tr>
                    ...
                    <td colspan='5' style="padding-left: 4px;">
                        <asp:TextBox ID="txtDescripcionEdicion" runat="server" Width="499px" Font-Names="Arial"
                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr style="display:none">
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="padding-left: 11px;">
                                    <asp:TextBox ID="txtMedidaEdicion" runat="server" Width="75px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold">
                                    Seccion
                ...
                <tr>
                    ...
                    <td colspan='5'>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtPrecio1Edicion" runat="server" Width="75px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold">
                                    Moneda
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCostoEdicion" runat="server" ForeColor="Blue" Font-Bold="True"
                                        Width="75px" Font-Names="Arial"></asp:TextBox>
                                </td>
                                <td style="padding-left: 3px; font-weight: bold">
                                    Precio 2
                                </td>
                ...
                <tr style="display:none">
                    ...
                    <td colspan='5' style="padding-left: 4px;">
                        <asp:TextBox ID="txtCostoMercadoEdicion" runat="server" Width="75px" ForeColor="Blue"
