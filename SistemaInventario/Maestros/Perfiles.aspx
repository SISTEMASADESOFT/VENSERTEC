...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                <tr style="width: 700px">
                    <td valign="top" style="width: 500px; height: 220px">
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 502px;
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="500">
                                    <tr>
                                        <td colspan="4" style="font-weight: bold; width: 65px">
                                            <asp:CheckBox ID="chkUsuario" runat="server" Text="Agregar Usuario" Font-Bold="True" />
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtClaveOperacionesEspeciales" runat="server" Width="150" Font-Names="Arial"
                                                            ForeColor="Blue" TextMode="Password" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="500">
                                    <tr>
                                        <td colspan="3" style="font-weight: bold; width: 65px">
                                            <asp:CheckBox ID="chkEmpleado" runat="server" Text="Agregar Empleado" Font-Bold="True" />
                                        </td>
                                        <td style="font-weight: bold; width: 65px">
                                            <asp:CheckBox ID="chkEliminarEmpleado" runat="server" Text="Eliminar Empleado" Font-Bold="True" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bold; width: 65px">
                    ...
                    <td valign="top" style="width: 300px; height: 200px">
                        <%--IMAGEN--%>
    ...
    <input id="hfCodEmpleado" type="hidden" value="0" />
</asp:Content>
