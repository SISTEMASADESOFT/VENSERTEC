    ...
    <div class="titulo" >Servicios</div> 
                     <div id="divTabs">
                        ...
                        <div id="div_consulta" style="padding-top:5PX;">
                                                    ...
                                                    <asp:TemplateField HeaderText="ID" Visible="false" >
                                                     ...
                                                     <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign ="Center" >
                                                        ...
                                                        <ItemTemplate>
                                                             ...
                                                             <asp:HiddenField ID="lblCodMaestroDetracciones" runat="server" Value='<%# Bind("CodMaestroDetracciones") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                           ...
                           <asp:TemplateField HeaderText="Detraccion" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <ItemTemplate>
                                                             <asp:Label runat="server" Width="400px" ID="lblDetraccion" Text='<%# Bind("Detraccion") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
