var AppSession = "../Maestros/UnionCodigoServicios.aspx";
    ...
    $('#MainContent_txtArticulo').autocomplete({
        source: function (request, response) {
            $.ajax({
                ...
                url: '../Servicios/Servicios.asmx/F_LGProductos_Servicios_Select',
...
//$('#MainContent_txtSerializacion').bind('keypress', function(e) {
//	if(e.keyCode==13){
//		alertify.log("hola");
//        return false;
//	}
