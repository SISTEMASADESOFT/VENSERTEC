...
var CodigoMenu = 1000; var CodigoInterno = 10;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnEdicion').click(function () {
        ...
        try {
            ...
            if (confirm("ESTA SEGURO ACTUALIZAR LOS DATOS DEL SERVICIO"))
                F_EdicionRegistro();
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_Servicios', result.split('~')[2]);
                        F_Update_Division_HTML('div_ServiciosEdicion', result.split('~')[3]);
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_CodDetraccion: $(Contenedor + 'ddlservicio').val()
        };
...
function F_AnularRegistro(Fila) {
    ...
    try {
        ...
        if (confirm("Esta seguro de eliminar el producto " + $(lblProducto_grilla).val()) == false)
            return false;
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var lblCodMaestroDetracciones = '#' + imgID.replace('imgEditarRegistro', 'lblCodMaestroDetracciones');
        var Cuerpo = '#MainContent_';

        $(Cuerpo + 'txtCodigoEdicion').val($(lblCodigo).text());
        $(Cuerpo + 'txtDescripcionEdicion').val($(lblDescripcion).text());
        $(Cuerpo + 'ddlservicioEdicion').val($(lblCodMaestroDetracciones).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Servicio: $(Contenedor + 'ddlservicioEdicion').val()
        };
