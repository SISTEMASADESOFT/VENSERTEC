<%@ Page Title="Tipo Cambio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TipoCambioWilliam.aspx.cs" Inherits="SistemaInventario.Maestros.TipoCambioWilliam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="TipoCambioWilliam.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 860px">
        Tipo de Cambio</div>
    <div id="tabRegistro" style="width: 860px">
                ...
                <div class="ui-jqdialog-content">
                    <table width="860">
                        <tr>
                            ...
                            <td  style="padding-left: 5px; font-weight: bold;display:none">
                                <asp:TextBox ID="txtParaleloCompra" runat="server" Width="65px" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 30px;">
                                <asp:HyperLink ID="HyperLink2" Target="_blank" runat="server" ForeColor="Blue" Font-Bold="True"
                                    Text="TIPO DE CAMBIO SBS" NavigateUrl="http://www.sbs.gob.pe/app/pp/SISTIP_PORTAL/Paginas/Publicacion/TipoCambioPromedio.aspx">TIPO DE CAMBIO SBS</asp:HyperLink>
                            </td>
            ...
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ID" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblCodTipoCambio" Text='<%# Bind("Codigo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <%--<asp:TemplateField HeaderText="Paralelo Compra" HeaderStyle-HorizontalAlign="Center">
                        <ItemStyle HorizontalAlign="Right" />
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblParaleloCompra" Text='<%# Bind("ParaleloCompra") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>--%>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tr>
                        ...
                        <td style="padding-left: 5px; font-weight: bold;display:none">
                            <asp:TextBox ID="txtParaleloCompraEdicion" runat="server" Width="65px" Font-Names="Arial"
