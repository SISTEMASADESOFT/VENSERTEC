...
var CodigoMenu = 1000; var CodigoInterno = 11;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnGrabar').click(function () {
        ...
        try {
            ...
            //poner autometicamente cero en lo default
            $('#MainContent_txtCostoSolesIgv').val('0');
            $('#MainContent_txtCostoConIgv').val('0');
            $('#MainContent_txtPrecio2').val('0');
            $('#MainContent_txtPrecio3').val('0');


            if (F_ValidarGrabarDocumento() == false)
                return false;

            if (confirm("ESTA SEGURO DE GRABAR ACTIVO FIJO"))
                F_GrabarDocumento();
            //                F_Nuevo();
            //            }
            return false;
    ...
    $('#MainContent_btnEdicion').click(function () {
        ...
        try {
            ...
            //poner autometicamente cero en lo default
            $('#MainContent_txtCostoSolesEdicion').val('0');
            $('#MainContent_txtCostoEdicion').val('0');
            $('#MainContent_txtPrecio2Edicion').val('0');
            $('#MainContent_txtPrecio3Edicion').val('0');

            if (F_ValidarEdicionDocumento() == false)
                return false;

            if (confirm("ESTA SEGURO DE ACTUALIZAR LOS DATOS DEL ACTIVO."))
                F_EdicionRegistro();
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_DescripcionAuxiliar: $(Contenedor + 'txtDescripcion').val(),
            ...
            Filtro_Precio2: $(Contenedor + 'txtPrecio1').val(),
            Filtro_Precio3: $(Contenedor + 'txtPrecio1').val(),
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        $(Cuerpo + 'txtPrecio1Edicion').val($(lblPrecio3_grilla).text());
        $(Cuerpo + 'txtPrecio2Edicion').val($(lblPrecio3_grilla).text());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_CodUnidadVenta: $(Contenedor + 'ddlCompraEdicion').val(),
            ...
            Filtro_Precio2: $(Contenedor + 'txtPrecio1Edicion').val(),
            Filtro_Precio3: $(Contenedor + 'txtPrecio1Edicion').val(),
            ...
            Filtro_CodEstado: 1,
            Filtro_DescripcionAuxiliarEdicion: $(Contenedor + 'txtDescripcion').val(),
