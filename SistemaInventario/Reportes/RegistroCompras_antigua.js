var AppSession = "../Reportes/RegistroCompras_antigua.aspx";
...
$().ready(function () {
    ...
    $(document).everyTime(600000, function () {
        ...
        $.ajax({
            type: "POST",
            url: '../Reportes/RegistroCompras.aspx/KeepActiveSession',
            data: {},
...
function F_Reporte() {
    ...
    rptURL = rptURL + 'FlagReporte=' + FlagReporte + '&';
    rptURL = rptURL + 'CodTipoArchivo=' + CodTipoArchivo + '&';
    rptURL = rptURL + 'TipoArchivo=' + TipoArchivo + '&';
    rptURL = rptURL + 'Periodo=' + $(Cuerpo + 'txtPeriodo').val() + '&';
