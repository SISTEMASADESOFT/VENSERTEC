var AppSession = "../Reportes/ReporteVentasPlaca.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 24;
    var Titulo = "REPORTE DE VENTAS POR PLACA";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombrePlaca = "PLACA :"+$("#MainContent_txtPlaca").val();
    var NombreArchivo = 'rptReporteVentasPlaca.rpt';
    var NombreHoja = '';
    ...
    rptURL = rptURL + 'NombrePlaca=' + NombrePlaca + '&';
