<%@ Page Title="Reporte de Ventas x Mes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_VentaMensuales_mercedes.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_VentaMensuales_mercedes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Ventas_VentaMensuales_mercedes.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">REPORTE POR MES</div> 
