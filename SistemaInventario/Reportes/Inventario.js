...
function F_VisualizarExcel() {
    ...
    var CodMenu = '3';
    var NombreArchivo = 'Xls_InventarioStockWilliam.xlsx';
    ...
    rptURL = rptURL + 'CodEstadoBusqueda=' + $('#MainContent_ddlFiltroCodEstado').val() + '&';
    rptURL = rptURL + 'Ubicacion=' + $('#MainContent_txtUbicacionConsulta').val() + '&';
