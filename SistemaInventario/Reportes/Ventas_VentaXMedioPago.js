var AppSession = "../Reportes/Ventas_VentaXMedioPago.aspx";
  ...
  //  if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Consultar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    try { 
        var objParams = {        
            ...
            Filtro_ChkCliente: Cliente,
            Filtro_CodCliente: $('#hfCodCtaCte').val(),
            Filtro_CodEmpleado: $('#MainContent_ddlVendedor').val()
        };
...
function F_Excel() {
    ...
    var NombreArchivo = 'Xls_Reporte_MedioPagoxMes.xlsx';
    var NombreHoja = 'Reporte';
    var Titulo = "REPORTE MEDIO DE PAGO X MES";

    var Titulo2 = "REPORTE DE INGRESO X MES";
    ...
    rptURL = rptURL + 'Hasta=' + $('#MainContent_txtHasta').val() + '&';
    rptURL = rptURL + 'CodMoneda=' + $('#MainContent_ddlMoneda').val() + '&';
    rptURL = rptURL + 'MONEDA=' + $('#MainContent_ddlMoneda option:selected').text() + '&';
