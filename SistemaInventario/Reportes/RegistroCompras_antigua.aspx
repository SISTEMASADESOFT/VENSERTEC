<%@ Page Title="Reporte Registro Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroCompras_antigua.aspx.cs" Inherits="SistemaInventario.Reportes.RegistroCompras_antigua" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="RegistroCompras_antigua.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Reporte de Registro de Compras</div> 
                                ...
                                <div id="divConsultaArticulo">
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                       ...
                                                       <asp:CheckBox ID="chkReporte" runat="server" Text="Formato de Registro Ventas Sunat"
                                                        Font-Bold="True" />
                                                       </td>
                                                       </tr>
