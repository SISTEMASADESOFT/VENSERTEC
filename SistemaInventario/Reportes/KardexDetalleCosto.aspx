<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KardexDetalleCosto.aspx.cs" Inherits="SistemaInventario.Reportes.KardexDetalleCosto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="KardexDetalleCosto.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 930px">Reporte de Kardex Detalle de Costo</div> 
                                        ...
                                        <table width="900">
                                                   ...
                                                   <tr>    
                                                           <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtPeriodo" runat="server" Width="50px" Font-Names="Arial" CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="100px" 
                                                                 />
                                                                <asp:Button ID="btnPdf" runat="server" Text="PDF" Font-Names="Arial" style="display:none;"
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="100px" 
                                                                 />
                                                                </td>
                                                       ...
                                                       <asp:TemplateField HeaderText="Código">                                                        
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:HyperLink 
                                                                ...
                                                                Font-Underline="true" ForeColor="Blue"  Font-Bold="True"  style="cursor:hand" 
                                                                Text='<%# Bind("Codigo") %>'                                                                
                                                                onclick="F_Reporte(this.id); return false;">
