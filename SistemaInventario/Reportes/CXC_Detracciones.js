var AppSession = "../Reportes/CXC_Detracciones.aspx";
...
//    var CodMenu = 402;
//    var CodTipoDoc = 18;
//    var Titulo = "REPORTE DE RETENCIONES";
...
function F_Reporte() {
    ...
    var CodTipoArchivo = 5;
    var CodMenu = 403;
    var CodtipoCobranza = 2;
    var Titulo = "REPORTE DE DETRACCIONES";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreHoja = 'COBRANZAS';
    var NombreArchivo = "Xls_ReporteRetenciones.xlsx";
    var NombreTabla = "ObligacionesTributarias";
    var NombreArchivo = "Web_Reporte_Cobranzas_rptDetracciones.rpt";
    ...
    rptURL = rptURL + 'Hasta=' + $('#MainContent_txtHasta').val() + '&';
    rptURL = rptURL + 'CodCliente=' + $('#hfCodCtaCte').val() + '&';
    rptURL = rptURL + 'CodtipoCobranza=' + CodtipoCobranza + '&';
    rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
