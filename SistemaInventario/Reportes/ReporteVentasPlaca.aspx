<%@ Page Title="Registro Ventas Placas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ReporteVentasPlaca.aspx.cs" Inherits="SistemaInventario.Reportes.ReporteVentasPlaca" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ReporteVentasPlaca.js" charset="UTF-8"></script>
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        <tr>
                            ...
                            <td style="width:55px">
                                <asp:TextBox ID="txtPlaca" runat="server" Width="100px" Font-Names="Arial" 
                        ...
                        <tr>
                         ...
                         <tr style = "display:none;">
                            ...
                            <td style="width:100px">
                                <asp:TextBox ID="txtCliente" runat="server" Width="100px" Font-Names="Arial" 
                                    ForeColor="Blue"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
