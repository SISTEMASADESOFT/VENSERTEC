<%@ Page Title="Registro Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroVentas.aspx.cs" Inherits="SistemaInventario.Reportes.RegistroVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroVentas.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Registro de Ventas</div>
    <div id="tabRegistro" style="width: 300px">
            ...
            <div id="divConsultaArticulo">
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                            <td colspan='2' >
                                <asp:CheckBox ID="chkReporte" runat="server" Text="Detallado"
                                    Font-Bold="True" />
                            </td>
                        </tr>
        ...
        <div>
                 <tr>
                        <td style="font-weight: bold; font-size: medium;width: 700px" colspan='2'>
                               En este reporte aparecera todo los documentos de compra ya sean Factura,Boletas y Notas de Pedido
                            </td>
                        </tr>
                </div>
    </div>
