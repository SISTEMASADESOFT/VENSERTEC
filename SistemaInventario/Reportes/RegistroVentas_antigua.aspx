<%@ Page Title="Registro Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroVentas_antigua.aspx.cs" Inherits="SistemaInventario.Reportes.RegistroVentas_antigua" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="RegistroVentas_antigua.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Reporte de Registro de Ventas</div> 
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                            ...
                                                            <td style="padding-left:5px;">
                                                                ...
                                                                <asp:TextBox ID="txtPeriodo" runat="server" Width="75px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                       </tr>
                                                       <tr>
                                                       <td colspan = '2' style="display:none;">
                                                       <asp:CheckBox ID="chkReporte" runat="server" Text="Formato de Registro Ventas Sunat" Font-Bold="True" />
                                                       </td>
                                                       </tr>
