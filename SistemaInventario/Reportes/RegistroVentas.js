var AppSession = "../Reportes/RegistroCompras.aspx";
...
function F_Reporte() {
    ...
    var chkReporte = 0
    if ($('#MainContent_chkReporte').is(':checked'))
        chkReporte = 1;
    ...
    var CodMenu = 304;
    var NombreArchivo = 'RegistroVentas.xlsx';
    ...
    rptURL = rptURL + 'Detallado=' + chkReporte + '&';
    rptURL = rptURL + 'CodCtaCte=' + $('#hfCodCtaCteConsulta').val() + '&';
