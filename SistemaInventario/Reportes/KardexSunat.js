var AppSession = "../Reportes/RegistroVentas.aspx";
...
$().ready(function () {
    ...
    $(document).everyTime(600000, function () {
        ...
        $.ajax({
            type: "POST",
            url: '../Reportes/KardexSunat.aspx/KeepActiveSession',
            data: {},
...
function F_VisualizarExcel() {
    ...
    var CodMenu = '4';
    var NombreArchivo = 'Xls_InventarioKardexSunatWilliam.xlsx';
    var NombreHoja = 'Inventario';
    var Titulo = 'Kardex Periodo ' + $('#MainContent_txtPeriodo').val();
    ...
    //    rptURL = rptURL + 'DscProducto=' + $('#MainContent_txtDscProducto').val() + '&';
    rptURL = rptURL + 'Periodo=' + $('#MainContent_txtPeriodo').val() + '&';
    //    rptURL = rptURL + 'Marca=' + chkMarca + '&';
    //    rptURL = rptURL + 'CodMarca=' + $('#hfCodMarca').val() + '&';
    //    rptURL = rptURL + 'Tipo=' + $('#MainContent_ddlTipo').val() + '&';
...
function F_VisualizarPdf() {
    ...
    var CodMenu = '2';
    var NombreArchivo = 'rptInventarioUnidadesFisicas.rpt';
    var NombreTabla = 'InventarioUnidadesFisicas';
