...
{
    public partial class Inventario_Stock_Minimo : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia()
        {
            ...
            dta_consultaarticulo.Columns.Add("UltimaCompra", typeof(string));
        ...
        protected void grvConsultaArticulo_DataBound(object sender, EventArgs e)
        {
            for (int rowIndex = grvConsultaArticulo.Rows.Count - 2; rowIndex >= 0; rowIndex--)
            {
                GridViewRow gvRow = grvConsultaArticulo.Rows[rowIndex];
                GridViewRow gvPreviousRow = grvConsultaArticulo.Rows[rowIndex + 1];
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_LGProductos_Inventario_StockMinimo(objEntidad);
