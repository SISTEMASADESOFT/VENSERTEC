var AppSession = "../Reportes/CXC_Creditos.aspx";
var ddlCliente;
...
function F_Buscar(){
    ...
    var Titulo = "REPORTE DE CREDITOS";
    ...
    if ($('#MainContent_chkRango').is(':checked')) {
        Titulo = "REPORTE DE CREDITOS HASTA " + $('#MainContent_txtHasta').val();
        CodMenu = 410;
    }

    if ($('#MainContent_chkClienteSumarizado').is(':checked')) {
        NombreArchivo = "Web_Reporte_Cobranzas_rptCobranzasGrupal_ClienteSumarizado.rpt";
    }
...
function F_Excel() {
    ...
    var Desde = $("#MainContent_txtDesde").val();
    var Hasta = $('#MainContent_txtHasta').val();
    var NombreHoja = 'COBRANZAS';
    var NombreArchivo = "Xls_ReporteCobranzas.xlsx";
