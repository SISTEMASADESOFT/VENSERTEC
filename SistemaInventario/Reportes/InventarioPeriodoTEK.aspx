<%@ Page Title="Inventario Periodo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InventarioPeriodo.aspx.cs" Inherits="SistemaInventario.Reportes.InventarioPeriodo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 500px">Reporte de Inventario Por Periodo (CONTABLE)</div> 
              

                        <div id="tabRegistro" style="width: 500px">
                          <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" >
                           <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" >
                                ...
                                <div id="divConsultaArticulo">
                                        ...
                                        <table width="400"   cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                           <td style="font-weight: bold">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtPeriodo" runat="server" Width="50px" Font-Names="Arial" CssClass="MesAnioPicker" ReadOnly="true"  ForeColor="Blue"></asp:TextBox>
                                                            </td>
