<%@ Page Title="Reporte de Ventas Vendedor x Mes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_VentaXVendedor_William.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_VentaXVendedor_William" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Ventas_VentaXVendedor_William.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">REPORTE POR VENDEDOR</div> 
                                    ...
                                    Font-Bold="True"></asp:TextBox>
                                         ...
                                         <tr>    
                                              ...
                                              <td>
                                                ...
                                                <tr>
                                                <td>
                                                <asp:TextBox ID="txtDesde" runat="server" Width="55px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="Jq-ui-dtp" ReadOnly="true"></asp:TextBox>
                                                </td>
                                              <td style="font-weight: bold">
                                                HASTA
                                              </td>
                                              <td style="padding-left:5px;">
                                                 <asp:TextBox ID="txtHasta" runat="server" Width="55px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="Jq-ui-dtp" ReadOnly="true"></asp:TextBox>
                                              </td>
                                                 </tr>
                                              </table>
                                              </td>
                                       ...
                                       <%--  <td  >
                                            ...
                                            <td>
                                            <asp:TextBox ID="txtCliente" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"Font-Bold="True"></asp:TextBox>
                                            </td>
                                        </tr>--%>
                                        <%--<tr>
