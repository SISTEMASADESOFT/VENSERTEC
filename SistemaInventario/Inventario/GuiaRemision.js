...
$(document).ready(function () {
    ...
    $('#MainContent_txtProveedor').autocomplete({
        ...
        select: function (e, i) {
           ...
           F_GuardarDireccion($('#hfNroRuc').val(),'#hfCodigoTemporal',$('#hfCodCtaCte').val()
            ,'#MainContent_txtProveedor',0,Ubigeo,Direccion,'#MainContent_ddldireccionNueva','#MainContent_ddldireccionNuevaDestino',1);
        },
        close: function () {
            $('#MainContent_txtNroRuc').val($('#hfNroRuc').val());
            $('#MainContent_txtProveedor').val($('#hfProveedor').val());
        },
        minLength: 3
    });
  ...
  $('#MainContent_txtConductorDNI').autocomplete({
      ...
      $('#MainContent_txtNroRucTransportista').autocomplete(   
    {
        ...
        select: function (e, i) {
            ...
            $('#hfTransportista').val(i.item.RazonSocial);
        ...
        close: function () {
            ...
            $('#MainContent_txtTransportista').val($('#hfTransportista').val());
        },
        minLength: 3
    });
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoDocumento']", function () {
    ...
    F_FormatosImpresion2();
                        ...
                        if ($('#MainContent_ddlTipoDocumento').val() === "10") {
//                             $('#tdtrasn1').css('display', 'block');
//                             $('#tdtrasn2').css('display', 'block');
                                $('#MainContent_txtTransportista').prop('disabled', false);
                                $('#MainContent_txtDireccionTransportista').prop('disabled', false);
                                $('#MainContent_dllDireccionTransportista').prop('disabled', false);
...
//                          $('#tdtrasn1').css('display', 'none');
//                             $('#tdtrasn2').css('display', 'none');
                                $('#MainContent_txtTransportista').prop('disabled', true);
                                $('#MainContent_txtDireccionTransportista').prop('disabled', true);
                                $('#MainContent_dllDireccionTransportista').prop('disabled', true);
...
$(document).on("change", "select[id $= 'MainContent_ddlMotivoTrabajo']",function () {
       if($("#MainContent_ddlMotivoTrabajo").val()!=4)
        {
         $('#MainContent_Label1').text('PARTIDA');
         $('#MainContent_Label3').text('DESTINO');
        }
        else
        {
         $('#MainContent_Label1').text('DESTINO');
         $('#MainContent_Label3').text('PARTIDA');
        }
} );

       $(document).on("change", "select[id $= 'MainContent_ddlSerie']",function () {
     BloqueoTipoTransportista($(Cuerpo + 'ddlSerie option:selected').text(),(Cuerpo + 'txtNumero'),(Cuerpo + 'txtEmision')
                 ,(Cuerpo + 'txtDestino'),
...
$(document).on("change", "select[id $= 'MainContent_ddlTipoTransportista']",function () {
             BloqueoTipoTransportista($(Cuerpo + 'ddlSerie option:selected').text(),(Cuerpo + 'txtNumeroGuia'),(Cuerpo + 'txtFechaTraslado')
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_codunidadpeso', result.split('~')[19]);
                        F_Update_Division_HTML('div_TipoTransportista', result.split('~')[18]);
...
//                                $('#MainContent_txtPeso').prop('disabled', false);
//                                F_Nuevo();
//                                $('#MainContent_dllDireccionTransportista').css('background', '#FFFFE0');  
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                       ...
                       ctrlPosActual = '#MainContent_grvConsultaArticulo_imgAgregar_0';
                        ...
                        $('.ccsestilo').css('background', '#FFFFE0');
                     $('#MainContent_lblcantidadregistroproductos').text(F_Numerar_Grilla("grvConsultaArticulo", 'hlkCodNeumaticoGv'));
...
//            Cadena = Cadena + '<p></p>' + 'Direccion';
        ...
        if($('#MainContent_chkGuia').prop('checked') && $('#MainContent_ddlTipoTransportista').val() == 1 &&  $("#MainContent_ddlSerie option:selected").text().substr(0, 1) == 'T')
{
...
if($('#MainContent_chkGuia').prop('checked') && $('#MainContent_ddlTipoTransportista').val() ==2 &&  $("#MainContent_ddlSerie option:selected").text().substr(0, 1) == 'T')
{
...
if($('#MainContent_chkGuia').prop('checked') && $('#MainContent_ddlTipoTransportista').val() ==3 &&  $("#MainContent_ddlSerie option:selected").text().substr(0, 1) == 'T')
{
   if ($('#MainContent_txtPlacaTraslado').val() == '')
            Cadena=Cadena + '<p></p>' + 'Placa';
}

              if (($('#MainContent_ddlSerie option:selected').text()).substring(0,1)==="T" && $('#MainContent_txtPeso').val() == '')
            Cadena = Cadena + '<p></p>' + 'Peso';

             

              if (($('#MainContent_ddlSerie option:selected').text()).substring(0,1)==="T" && $('#MainContent_txtNuBultos').val() == '')
            Cadena = Cadena + '<p></p>' + 'NroBultos';

             if (($('#MainContent_ddlSerie option:selected').text()).substring(0,1)==="T" && $('#MainContent_ddlMotivoTrabajo').val() == 7)
          Cadena = Cadena + '<p></p>' + 'Las Guias Electronicas no pueden tener como operacion entre estab. la misma empresa';
...
//    if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Insertar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try 
        ...
        if ($.trim($(Contenedor + 'txtNuBultos').val()) != '')
           ...
           if($("#MainContent_ddlMotivoTrabajo").val()!=4)
        {
         CodPartida=$(Contenedor + 'ddlAlmacenFisico').val();
         Partida=$(Contenedor + 'txtPartida').val();
         Destino=$("#MainContent_ddldireccionNuevaDestino option:selected").text();
//         CodDestino=$(Contenedor + 'ddlDestino').val();
        CodDestino=$(Contenedor + 'ddldireccionNuevaDestino').val();
         
        }
        else
        {
         CodPartida=$(Contenedor + 'ddldireccionNuevaDestino').val();
         Partida=$("#MainContent_ddldireccionNuevaDestino option:selected").text();
         Destino=$(Contenedor + 'txtPartida').val();
         CodDestino=$(Contenedor + 'ddlAlmacenFisico').val();
        }
              

        var objParams = {
                Filtro_CodAlmacenFisico: CodPartida,
                Filtro_CodDocumentoVenta: $('#hfCodigoTemporal').val(),
                Filtro_FechaEmision: $(Contenedor + 'txtEmision').val(),
                Filtro_FechaTraslado: $(Contenedor + 'txtTraslado').val(),
                Filtro_SerieDoc: $("#MainContent_ddlSerie option:selected").text(),
                Filtro_NumeroDoc: $(Contenedor + 'txtNumero').val(),
                Filtro_CodMotivoInterno: 3,
                Filtro_CodAlmacenLlegada: CodDestino,
                Filtro_Partida: CodPartida,
...
//                Filtro_CodDireccionTrans: $('#MainContent_dllDireccionTransportista').val(),
//                Filtro_DireccionTrans: $("#MainContent_ddlDireccionTransportista option:selected").text(),                
                ...
                Filtro_CodPeso:$('#MainContent_ddlcodunidadpeso').val(),
                    ...
                    if (str_mensaje_operacion == 'Se grabo correctamente')
                    {
                         ...
                         if ($('#MainContent_chkImpresion').is(':checked') | $('#MainContent_chkImpresionTicket').is(':checked')) 
                         {
                             ...
                             if($('#MainContent_chkImpresionTicket').is(':checked'))
                                Tipo = 'TK';
                             F_ImprimirFactura(result.split('~')[2],200,'IMP');
                         }
...
function F_Nuevo(){
        ...
        $('#MainContent_ddlTipoDocumento').val(10);
        $('#hfCodigoTemporal').val('0');
        $('#hfCodCtaCte').val('0');
        $('#hfCodTransportista').val('0');
        $('#hfDniConductor').val('0');
        $('#hfCodConductor').val('0');
        $('#hfNombreConductor').val('0');
        $('#MainContent_txtProveedor').val('');
    ...
    try 
        {
              ...
              var objParams = {
                ...
                if (str_resultado_operacion == "1") 
                {
                    ...
                    var fila = '#' + this.id;
                    //var hfAutomatico = fila.replace("lblNumero", "hfAutomatico");
                    var lblEstado = fila.replace("lblNumero", "lblEstado");                    
//                    var imgAutomatico = fila.replace("lblNumero", "imgAutomatico");
    ...
    if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            if($(hfAutomatico).val()==1){
             ...
             if(($(lblNumero).text()).substring(0,1)==="T"){
                toastr.warning('LA GUIA ES ELECTRONICA, POR LO QUE NO SE PUEDE MODIFICAR');
                return false;
            }
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
        rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
        rptURL = rptURL + 'TipoImp=' + TipoImp + '&';
        window.open(rptURL, "PopUpRpt", Params);
        
    return false;
}

function F_ImprimirGuia2(Fila, rplc, TipoImp, TipoDoc)  {
        var rptURL = '';
        var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
        var TipoArchivo = 'application/pdf';
        var CodTipoArchivo = '5';
        var CodMenu = '200';
        var CodNotaIngreso = $("#" + Fila.id.replace(rplc, "hfCodigo")).val();
        var NombreTabla = "";
        var NombreArchivo = "";
...
//         if(($(lblNumero).text()).substring(0,1)==="T"){
//                toastr.warning('LA GUIA ES ELECTRONICA, POR LO QUE NO SE PUEDE ANULAR');
//                return false;
//            }
...
function F_ImprimirFacturaGrilla(Fila,Tipo) {
        ...
        if (Tipo == 'TK')
        {
           lblCodigo = '#' + imgID.replace('imgTCK', 'hfCodigo');     
           lblEstado = '#' + imgID.replace('imgTCK', 'lblEstado');       
        }
        else
        {
           lblCodigo = '#' + imgID.replace('imgimpPdf', 'hfCodigo');     
           lblEstado = '#' + imgID.replace('imgimpPdf', 'lblEstado');       
        }
...
function F_Inicializar_CajaTexto(){
    ...
    $("#MainContent_txtTraslado").css('background', '#FFFFE0');
