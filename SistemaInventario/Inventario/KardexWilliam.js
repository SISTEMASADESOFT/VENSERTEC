var AppSession = "../Inventario/KardexWilliam.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_txtFechaRegistro').css('background', '#FFFFE0');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#lblGrillaConsulta').text(F_Numerar_Grilla("grvKardex", 'lblRegistro'));
...
function F_EditarSaldoInicial(Fila) {
    ...
    try {
        ...
        var lblRegistro = '#' + imgID.replace('imgEditarDocumento', 'lblRegistro');
        ...
        $('#MainContent_txtFechaRegistro').val($(lblRegistro).text());
...
function F_EdicionSaldoInicial() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_FechaRegistro: $('#MainContent_txtFechaRegistro').val()
        };
...
function F_LlenarGridDetalle(Fila) {
    try {
        ...
        var Coddoc = $('#' + Fila.replace('pnlOrders', 'hfcoddoc')).val();
        var codtipodocnota = $('#' + Fila.replace('pnlOrders', 'hfcodtipodocnota')).val();
                ...
                var objParams =
                        {
                            ...
                            Filtro_codtipodocnota: codtipodocnota,
                        };
...
function F_HistorialMovimientos(Fila) {
    ...
    try {
        ...
        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_ConsultaHistorialMovimientos_NET(arg, function (result) {
            var str_resultado_operacion = "";
            var str_mensaje_operacion = "";

            if (result.split('~')[1] == "") {

                F_Update_Division_HTML('div_grvHistorialMovimientos', result.split('~')[2]);
                ...
                $("#div_HistorialMovimientos").dialog({
                    resizable: false,
                    modal: true,
                    title: "Historial de Movimientos de Productos",
                    title_html: true,
                    height: 500,
                    width: 850,
                    autoOpen: false
                ...
                $('#div_HistorialMovimientos').dialog('open');
            }
            else {
