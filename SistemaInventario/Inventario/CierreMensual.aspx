<%@ Page Title="Cierre Mensual" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CierreMensual.aspx.cs" Inherits="SistemaInventario.Inventario.CierreMensual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="CierreMensual.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Cierre Mensual</div> 
                          ...
                          <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" >
                                ...
                                <div id="divConsultaArticulo">
                                    ...
                                    <div  class="linea-button">
                                      <asp:Button ID="btnReporte" runat="server" Text="GRABAR" Font-Names="Arial"
