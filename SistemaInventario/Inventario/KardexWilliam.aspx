<%@ Page Title="Kardex" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="KardexWilliam.aspx.cs" Inherits="SistemaInventario.Inventario.KardexWilliam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="KardexWilliam.js" charset="UTF-8"></script>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-Width="34px" >
                    <ItemTemplate>
                     ...
                     <%--   <asp:ImageButton runat="server" ID="imgHistorialMovimientos" ImageUrl="../Asset/images/historial2.png"
                        ToolTip="HISTORIAL DE MOVIMIENTOS" OnClientClick="F_HistorialMovimientos(this); return false;"
                ...
                <asp:BoundField DataField="Usuario" HeaderText="Usuario">
                  ...
                  <asp:TemplateField HeaderText="Registro">
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblRegistro" Text='<%# Bind("Registro") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div id="divEdicionRegistro" style="display: none;">
        <div class="ui-jqdialog-content">
            ...
            <tr>
                    ...
                    <td>
                     <asp:TextBox ID="txtFechaRegistro" runat="server" Width="55px" CssClass="Jq-ui-dtp" Font-Names="Arial"
                         ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
     ...
     <div id="div_HistorialMovimientos" style="display: none;">
            
            <div id="div_tab2" style="width: 800px;">
            
            <div id="tabMovimientos">
                <div id="div_grvHistorialMovimientos" style="padding-top: 5px;">
                    <asp:GridView ID="grvHistorialMovimientos" runat="server" AutoGenerateColumns="False"
                        border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                        Width="800px">
                        <Columns>
                            <asp:BoundField DataField="FechaRegistro" HeaderText="Registro" HeaderStyle-Width="20px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Usuario" HeaderText="Usuario" HeaderStyle-Width="20px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FechaIngresoAntigua" HeaderText="Fecha Ingreso Antigua" HeaderStyle-Width="30px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FechaIngresoNueva" HeaderText="Fecha Ingreso Nueva" HeaderStyle-Width="30px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="SaldoInicialAntiguo" HeaderText="Saldo Inicial Antiguo" HeaderStyle-Width="30px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                             <asp:BoundField DataField="SaldoInicialNuevo" HeaderText="Saldo Inicial Nuevo" HeaderStyle-Width="30px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
