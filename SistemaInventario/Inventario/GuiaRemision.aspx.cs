...
namespace SistemaInventario.Inventario
{
    public partial class GuiaRemision : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion, ref ddlSerieConsulta,
                    ref ddlAlmacen, ref ddlTipoDocumento, ref ddlTipoDocConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlTipoTransportista, ref ddlcodunidadpeso);
            ...
            str_resultado =
                ...
                str_ddl_TipoTransportista_html + "~" +//18
                str_ddl_CodUnidadpeso_html; //19
        ...
        public String F_DireccionTransportista_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_dllDireccionTransportista_html = "";
            int int_resultado_operacion = 0;
            String MsgError = "";
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                str_dllDireccionTransportista_html = Mod_Utilitario.F_GetHtmlForControl(dllDireccionTransportista);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_dllDireccionTransportista_html;
        ...
        public String F_DireccionProveedor_NET(String arg)
        {
            ...
            try
            {
                ...
                str_dllDireccionTransportista_html = Mod_Utilitario.F_GetHtmlForControl(ddlDestino);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combomotivotrabajo,
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_TipoTransportista,  ref DropDownList ddl_CodunidadPeso)
        {
            DataTable dta_consulta = null;
            ...
            ddl_TipoDocumentoConsulta.DataValueField = "CodDoc";
            ...
            TCConceptosDetCE objEntidadConceptosDet = null;

            objEntidadConceptosDet = new TCConceptosDetCE();
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            {
                objOperacion.F_TemporalFacturacionDet_Insert_William(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_TemporalFacturacionDetalle_Insert_William(objEntidad);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodProforma)
        {
            ...
            objEntidad.CodDireccionTrans = Convert.ToInt32(objTablaFiltro["Filtro_CodDireccionTrans"]);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_DireccionTransportista(Hashtable objTablaFiltro)
        {
            ...
            dllDireccionTransportista.Items.Clear();

            dllDireccionTransportista.DataSource = dtTabla;
            dllDireccionTransportista.DataTextField = "Direccion";
            dllDireccionTransportista.DataValueField = "CodDireccion";
            dllDireccionTransportista.DataBind();
        }
