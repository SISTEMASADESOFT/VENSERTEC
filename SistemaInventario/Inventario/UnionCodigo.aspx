<%@ Page Title="Union Codigos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnionCodigo.aspx.cs" Inherits="SistemaInventario.Inventario.UnionCodigo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="UnionCodigo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
         ...
         <div class="titulo"  style="width: 600px">UNION DE CODIGOS</div> 
                                        ...
                                        <div class="ui-jqdialog-content"  style="width: 600px;">
                                          <table cellpadding="0" cellspacing="0" class="form-inputs" width="600">
                                            ...
                                            PRODUCTO CORRECTO
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtArticulo" runat="server" Width="425px"  Font-Names="Arial"   ForeColor="Blue"  Font-Bold="True"  ></asp:TextBox>
                                                </td>
                                             </tr>
                                             <tr>
                                             <td  style="font-weight: bold;">
                                            PRODUCTO INCORRECTO
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCodProductoIncorrecto" runat="server" Width="425px"  Font-Names="Arial"   ForeColor="Blue"  Font-Bold="True"  ></asp:TextBox>
                                                </td>
                                             </tr>
     ...
     <input id="hfCodProductoCorrecto" type="hidden"  value="0" />
     <input id="hfCodProductoIncorrecto" type="hidden"  value="0" />
