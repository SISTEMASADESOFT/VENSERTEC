...
//    $("#MainContent_txtContraseña").blur(function () {
        ...
        var objParams =
            {
                ...
                Filtro_Almacen: $('#MainContent_ddlSucursal option:selected').text()
            };
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_mensaje_operacion == "") {
                        //   document.location = 'Reportes/ConstruirExcel.aspx';
                        VerificarSession = true;
                        document.location = 'Maestros/TipoCambioWilliam.aspx';
                        return false;
                    }
                    else {
