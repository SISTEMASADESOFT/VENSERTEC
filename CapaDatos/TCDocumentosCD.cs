   ...
   public class TCDocumentosCD
    {
       ...
       //Procedimiento que trae los tipos de documentos para la facturacion
       //en una sola ventana (factura, boleta, cotizacion, nota de venta (pedido)
           ...
           try
           {
               ...
               using (SqlConnection sql_conexion = new SqlConnection())
               {
                   ...
                   using (SqlCommand sql_comando = new SqlCommand())
                   {
                       ...
                       sql_comando.Connection = sql_conexion;
                       sql_comando.CommandType = CommandType.StoredProcedure;
                       sql_comando.CommandText = "pa_TCDocumentos_ListarFacturacion";
       ...
       public DataTable F_TCDocumentos_ListarFacturacion_Cotizacion()
       {
           ...
           try
           {
               ...
               using (SqlConnection sql_conexion = new SqlConnection())
               {
                   ...
                   using (SqlCommand sql_comando = new SqlCommand())
                   {
                       ...
                       sql_comando.Connection = sql_conexion;
                       sql_comando.CommandType = CommandType.StoredProcedure;
                       sql_comando.CommandText = "pa_TCDocumentos_ListarFacturacion_Cotizacion";
