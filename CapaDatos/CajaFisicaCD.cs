...
namespace CapaDatos
{
    ...
    {
        public DataTable F_CajaFisica_Listar(int CodEstado)
        {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@MontoSolesDepositar", SqlDbType.Decimal).Value = objEntidad.MontoSolesDepositar;
                        ...
                        sql_comando.Parameters.Add("@MontoDolaresDepositar", SqlDbType.Decimal).Value = objEntidad.MontoDolaresDepositar;
        ...
        public DataTable F_dtCajaFisica_Listar_william(int CodEstado, int CodAlmacen, int CodEmpresa)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_CajaFisica_Listar_william";
