   ...
   public class UsuarioCD
    {
           ...
           try
           {
               ...
               using (SqlConnection sql_conexion = new SqlConnection())
               {
                   ...
                   using (SqlCommand sql_comando = new SqlCommand())
                   {
                       ...
                       sql_comando.Parameters.Add("@nvNombreUsuario", SqlDbType.VarChar,160).Value = objEntidadBE.NombreUsuario;
                       sql_comando.Parameters.Add("@Clave", SqlDbType.VarChar,60).Value = objEntidadBE.Clave;
       ...
       public DataTable F_UsuarioEmpleado_Obtener(int CodUsuario, int CodEmpleado)
       {
           DataTable dta_consulta = null;
           ...
           try
           {
               using (SqlConnection sql_conexion = new SqlConnection())
               {
                   ...
                   using (SqlCommand sql_comando = new SqlCommand())
                   {
                       ...
                       sql_comando.Parameters.Add("@CodUsuario", SqlDbType.Int).Value = CodUsuario;
                       if (CodEmpleado > 0)
                           sql_comando.Parameters.Add("@CodEmpleado", SqlDbType.Int).Value = CodEmpleado;
       ...
       public DataTable F_UsuariosPermisos_Verificar(int CodUsuario, int CodigoMenu, int CodigoInterno)
       {
                   ...
                   if (Conectado == true)
                       try
                       {
                           using (SqlCommand sql_comando = new SqlCommand())
                           {
                               ...
                               sql_comando.Parameters.Add("@FlagUsuario", SqlDbType.Int).Value = objEntidad.FlagUsuario;
                               sql_comando.Parameters.Add("@FlagEmpleado", SqlDbType.Int).Value = objEntidad.FlagEmpleado;
                   ...
                   if (Conectado == true)
                       try
                       {
                           using (SqlCommand sql_comando = new SqlCommand())
                           {
                               ...
                               sql_comando.Parameters.Add("@FlagUsuario", SqlDbType.Int).Value = objEntidad.FlagUsuario;
                               sql_comando.Parameters.Add("@FlagEmpleado", SqlDbType.Int).Value = objEntidad.FlagEmpleado;
                               sql_comando.Parameters.Add("@FlagEliminarEmpleado", SqlDbType.Int).Value = objEntidad.FlagEliminarEmpleado;
