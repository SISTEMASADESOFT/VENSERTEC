...
namespace CapaDatos
{
    public class DocumentoVentaCabCD
    {
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@Igv", SqlDbType.Decimal).Value = objEntidadBE.Igv;
                        sql_comando.Parameters.Add("@Total", SqlDbType.Decimal).Value = objEntidadBE.Total;
                        sql_comando.Parameters.Add("@TotalTarjeta", SqlDbType.Decimal).Value = objEntidadBE.TotalTarjeta;
                        ...
                        sql_comando.Parameters.Add("@Placa3", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa3;
                        sql_comando.Parameters.Add("@Placa4", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa4;
                        sql_comando.Parameters.Add("@Placa5", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa5;
                        sql_comando.Parameters.Add("@Placa6", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa6;
                        sql_comando.Parameters.Add("@Placa7", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa7;
                        ...
                        sql_comando.Parameters.Add("@MarcaVehiculo", SqlDbType.VarChar, 50).Value = objEntidadBE.MarcaVehiculo;
                        ...
                        sql_comando.Parameters.Add("@CodUnidadPeso", SqlDbType.Int).Value = objEntidadBE.CodUnidadPeso;
                        sql_comando.Parameters.Add("@CodConductor", SqlDbType.Int).Value = objEntidadBE.CodConductor;
                        sql_comando.Parameters.Add("@ObservacionGuia", SqlDbType.VarChar, 2000).Value = objEntidadBE.ObservacionGuia;
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
        ...
        //Insert de la Factura que Contiene Notas de Pedido
        ...
        //Insert de la Factura que Contiene Notas de Pedido
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_Factura_NV_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@NroOC", SqlDbType.VarChar, 100).Value = objEntidadBE.NroOC;
                        sql_comando.Parameters.Add("@Requerimiento", SqlDbType.VarChar, 200).Value = objEntidadBE.Requerimiento;
                        sql_comando.Parameters.Add("@Codtipodoctemporal", SqlDbType.Int).Value = objEntidadBE.Codtipodoctemporal;
                        sql_comando.Parameters.Add("@CodDocumentoVentaDireccion", SqlDbType.Int).Value = objEntidadBE.CodDocumentoVentaDireccion;
                        sql_comando.Parameters.Add("@CodTipoOperacion", SqlDbType.Int).Value = objEntidadBE.CodTipoOperacion;
        ...
        //Insert de la Factura que Contiene Notas de Pedido
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_Factura_NV_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        if (objEntidadBE.CodResponsable != 0)
                        {
                            sql_comando.Parameters.Add("@CodResponsable", SqlDbType.Int).Value = objEntidadBE.CodResponsable;
                            if (objEntidadBE.Responsable2 != "")
                                sql_comando.Parameters.Add("@Responsable2", SqlDbType.VarChar, 100).Value = objEntidadBE.Responsable2;
                            if (objEntidadBE.Responsable2DNI != "")
                                sql_comando.Parameters.Add("@Responsable2DNI", SqlDbType.VarChar, 8).Value = objEntidadBE.Responsable2DNI;
                        }
        ...
        //Insert de la Nota de Pedido en Bruto
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_NP_OC_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@Placa3", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa3;
                        sql_comando.Parameters.Add("@Placa4", SqlDbType.VarChar, 20).Value = objEntidadBE.Placa4;
                        sql_comando.Parameters.Add("@CodVendedor", SqlDbType.VarChar, 20).Value = objEntidadBE.CodVendedor;
                        ...
                        if (objEntidadBE.Responsable != "")
                            sql_comando.Parameters.Add("@Responsable", SqlDbType.VarChar, 100).Value = objEntidadBE.Responsable;
                        if (objEntidadBE.ResponsableDNI != "")
                            sql_comando.Parameters.Add("@ResponsableDNI", SqlDbType.VarChar, 8).Value = objEntidadBE.ResponsableDNI;
        ...
        //Insert de la Nota de Pedido en Bruto
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_NP_OC_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
        ...
        public DataTable F_DocumentoVentaCab_Listar_William(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        if (objEntidadBE.CodMoneda != 0)
                            sql_comando.Parameters.Add("@CodMoneda", SqlDbType.Int).Value = objEntidadBE.CodMoneda;
                        if (objEntidadBE.Estado != "TODOS")
                            sql_comando.Parameters.Add("@Estado", SqlDbType.VarChar, 20).Value = objEntidadBE.Estado;
                        if (objEntidadBE.EstadoNP != 0)
                            sql_comando.Parameters.Add("@EstadoNP", SqlDbType.Int).Value = objEntidadBE.EstadoNP;
        ...
        public DataTable F_Proformacab_Listar_William(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Proforma_Listar";
        ...
        public DataTable F_DocumentoVentaCab_Listar_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
        ...
        public DataTable F_CorreosDocumentosEnvios_ListarCab(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_CorreosDocumentosEnvios_ListarCab";
        ...
        public DataTable F_DocumentoVentaCab_Listar_NP(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_Listar_NP";
        ...
        public DataTable F_DocumentoVentaCab_Listar_NP_William(DocumentoVentaCabCE objEntidadBE)
        {
        ...
        public DataTable F_DocumentoVentaCab_Listar_NP_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_Anulacion_Mercedes(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodtipoCobranza", SqlDbType.Int).Value = objEntidadBE.CodtipoCobranza;
                        sql_comando.Parameters.Add("@Detraccion", SqlDbType.VarChar, 5).Value = objEntidadBE.Detraccion;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@IP_INSERT", SqlDbType.VarChar, 250).Value = objEntidadBE.IP;
        ...
        public DataTable F_DocumentoVentaCab_VentaIngresos(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_VentaIngresos";
        ...
        public DataTable F_DocumentoVentaCab_FacturaRetencion(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_FacturaRetencion";
        ...
        public DataTable F_DocumentoVentaCab_Listar_Retenciones(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_Listar_Retenciones";
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodAlmacenPartida", SqlDbType.Int).Value = objEntidadBE.CodSede;
                        sql_comando.Parameters.Add("@CodProducto", SqlDbType.Int).Value = objEntidadBE.CodProducto;
                        sql_comando.Parameters.Add("@CodUsuario", SqlDbType.Int).Value = objEntidadBE.CodUsuario;
        ...
        public DataTable F_DocumentoVentaCab_Impresion_NotaPedido(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_Impresion_NotaPedido";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodDocumentoVenta", SqlDbType.Int).Value = objEntidadBE.CodDocumentoVenta;
                        sql_comando.Parameters.Add("@Correos", SqlDbType.VarChar, 1000).Value = objEntidadBE.Correos;
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_ReenvioMail_Documentos(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "[pa_DocumentoVentaCab_ReenvioMail_Documentos]";
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_ReenvioMail_Mail(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodDocumentoVenta", SqlDbType.Int).Value = objEntidadBE.CodDocumentoVenta;
                        sql_comando.Parameters.Add("@Correos", SqlDbType.VarChar, 100).Value = objEntidadBE.Correos;
        ...
        public DataTable F_DocumentoVentaCab_ImpresionConfiguracion(int CodEmpresa, int CodSede,
                                                                    ...
                                                                    string TipoImpPorDefecto, int CodDocumentoVenta)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@Placa5", SqlDbType.VarChar, 10).Value = objEntidadBE.Placa5;
                        sql_comando.Parameters.Add("@Placa6", SqlDbType.VarChar, 10).Value = objEntidadBE.Placa6;
                        sql_comando.Parameters.Add("@Placa7", SqlDbType.VarChar, 10).Value = objEntidadBE.Placa7;
                        sql_comando.Parameters.Add("@Placa8", SqlDbType.VarChar, 10).Value = objEntidadBE.Placa8;
                        sql_comando.Parameters.Add("@KM", SqlDbType.VarChar, 50).Value = objEntidadBE.KM;
                        sql_comando.Parameters.Add("@CodUsuario", SqlDbType.Int).Value = objEntidadBE.CodUsuario;
                        sql_comando.Parameters.Add("@NroOperacion", SqlDbType.VarChar, 20).Value = objEntidadBE.NroOperacion;
                        ...
                        //sql_comando.Parameters.Add("@Recepcion", SqlDbType.SmallDateTime, 100).Value = SqlDateTime.MinValue;
                        sql_comando.Parameters.Add("@Observacion", SqlDbType.VarChar, 250).Value = objEntidadBE.Observacion;
                        sql_comando.Parameters.Add("@NroOC", SqlDbType.VarChar, 20).Value = objEntidadBE.NroOC;
                        sql_comando.Parameters.Add("@Requerimiento", SqlDbType.VarChar, 200).Value = objEntidadBE.Requerimiento;
                        ...
                        //sql_comando.Parameters.Add("@Transportista  ", SqlDbType.VarChar, 200).Value = objEntidadBE.Transportista;
                        //sql_comando.Parameters.Add("@RucTransportista  ", SqlDbType.VarChar, 11).Value = objEntidadBE.NroRucTransportista;
                        ...
                        sql_comando.Parameters.Add("@Responsable", SqlDbType.VarChar, 200).Value = objEntidadBE.Responsable;
                        sql_comando.Parameters.Add("@ResponsableDNI", SqlDbType.VarChar, 200).Value = objEntidadBE.ResponsableDNI;
                        sql_comando.Parameters.Add("@Responsable2", SqlDbType.VarChar, 200).Value = objEntidadBE.Responsable2;
                        sql_comando.Parameters.Add("@Responsable2DNI", SqlDbType.VarChar, 200).Value = objEntidadBE.Responsable2DNI;
        ...
        public DataTable F_CorreosFacturasCotizaciones(int CodDocumentoVenta)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_CorreosFacturaCotizacion";
                        sql_comando.Parameters.Add("@CodDocumentoVenta", SqlDbType.Int).Value = CodDocumentoVenta;
                        dta_consulta = new DataTable();
                        dta_consulta.Load(sql_comando.ExecuteReader());
                        return dta_consulta;
        ...
        public DataTable F_CorreosDocumentosEnvios_Listar(int CodDocumentoVenta, int CodProforma)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_CorreosDocumentosEnvios_Listar";
                        sql_comando.Parameters.Add("@CodDocumentoVenta", SqlDbType.Int).Value = CodDocumentoVenta;
                        sql_comando.Parameters.Add("@CodProforma", SqlDbType.Int).Value = CodProforma;
                        dta_consulta = new DataTable();
                        dta_consulta.Load(sql_comando.ExecuteReader());
                        return dta_consulta;
                    }
        ...
        public CorreosDocumentosEnvios F_CorreosDocumentosEnvios_Actualizar(int CodDocumentoVenta, int CodProforma, string idTransaccion, int Enviado, string Mensaje)
        {
            try
            {
                CorreosDocumentosEnvios objEntidadBE = new CorreosDocumentosEnvios();
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.CommandText = "pa_CorreosDocumentosEnvios_Actualizar";
                        sql_comando.Parameters.Add("@CodDocumentoVenta", SqlDbType.Int).Value = CodDocumentoVenta;
                        sql_comando.Parameters.Add("@CodProforma", SqlDbType.Int).Value = CodProforma;
                        sql_comando.Parameters.Add("@idTransaccion", SqlDbType.VarChar, 20).Value = idTransaccion;
                        sql_comando.Parameters.Add("@Enviado", SqlDbType.Int).Value = Enviado;
                        sql_comando.Parameters.Add("@Mensaje", SqlDbType.VarChar, 1000).Value = Mensaje;
        ...
        public DataTable F_Proforma_Reemplazar(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Proforma_Reemplazar";
        ...
        public DataTable F_AgregarTemporan_NP_Varios(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_AgregarTemporan_NP_Varios";
        ...
        public DataTable F_Obtener_Documento_CorreoPendinteEnvio()
        {
            #region VARIABLES
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "usp_search_primary_Tst_Seguimiento_Documentos_FactElectronica_Sunat";
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@CodtipoCobranza", SqlDbType.Int).Value = objEntidadBE.CodtipoCobranza;
                        sql_comando.Parameters.Add("@Detraccion", SqlDbType.VarChar, 20).Value = objEntidadBE.Detraccion;
        ...
        public DataTable F_Reporte_Ventas_Placa(DocumentoVentaCabCE objEntidadVenta)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_REPORTE_VENTAS_PLACA";

                        if (objEntidadVenta.CkhCliente !=0)
                            sql_comando.Parameters.Add("@CodCliente", SqlDbType.Int).Value = objEntidadVenta.CodCliente;
                        ...
                        sql_comando.Parameters.Add("@Placa", SqlDbType.VarChar,15).Value = objEntidadVenta.Placa;
        ...
        public DataTable F_ListarCorreos(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_ListarCorreos";
        ...
        public DataTable F_DocumentoVentaCab_Facturar(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_Facturar";
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_Insert_Edicion_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_DocumentoVentaCab_Insert_Edicion";
                        ...
                        sql_comando.Parameters.Add("@CodFacturaAnterior", SqlDbType.VarChar, 8).Value = objEntidadBE.CodFactura_Anterior;
                        sql_comando.Parameters.Add("@DireccionTrans", SqlDbType.VarChar, 100).Value = objEntidadBE.DireccionTrans;
                        sql_comando.Parameters.Add("@Observacion", SqlDbType.VarChar, 100).Value = objEntidadBE.Observacion;
                        sql_comando.Parameters.Add("@CodTransportista", SqlDbType.Int).Value = objEntidadBE.CodTransportista;
                        sql_comando.Parameters.Add("@CodDireccionTransportista", SqlDbType.Int).Value = objEntidadBE.CodDireccionTransportista;
        ...
        public DocumentoVentaCabCE F_DocumentoVentaCab_NotaCredito_Insert_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
        ...
        public DocumentoVentaCabCE F_Proforma_Validar_Factura(DocumentoVentaCabCE objEntidad)
        {
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Proformacab_Validar_Factura";
        ...
        public DocumentoVentaCabCE F_Documentoventa_Validar_Factura(DocumentoVentaCabCE objEntidad)
        {
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Documentoventa_Validar_Factura";
        ...
        public DocumentoVentaCabCE F_TemporalFacturacionDet_Insert_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_TemporalFacturacionDet_Insert_William";
        ...
        public DocumentoVentaCabCE F_TemporalFacturacionDetalle_Insert_William(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_TemporalFacturacionDetalle_Insert_william";
        ...
        public DataTable F_Detracciones_REPORTE(DocumentoVentaCabCE objEntidadBE)
        {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_Detracciones_REPORTE";
        ...
        public DataTable F_DOCUMENTOVENTACAB_VENTAS_MENSUALES(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_DOCUMENTOVENTACAB_VENTAS_MENSUALES";
                        //cambiar
                        sql_comando.Parameters.Add("@Desde", SqlDbType.VarChar, 8).Value = objEntidadBE.DesdeInt;
                        sql_comando.Parameters.Add("@Hasta", SqlDbType.VarChar, 8).Value = objEntidadBE.HastaInt;
                        //sql_comando.Parameters.Add("@Ruta", SqlDbType.Int).Value = objEntidadBE.Ruta;
        ...
        public DataTable F_DOCUMENTOVENTACAB_VENTAS_MENSUALES_LUBRICENTRO(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    sql_conexion.ConnectionString = ConfigurationManager.ConnectionStrings["BDVENSERTEC_PRUEBAS2"].ConnectionString;
                    sql_conexion.Open();
        ...
        public DataTable F_Cobranzas_Reporte_COBRADOS_HASTA_Credito(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Cobranzas_Reporte_COBRADOS_HASTA_CREDITO";
        ...
        public DataTable F_DOCUMENTOVENTACAB_MEDIOPAGO_MENSUALES(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_DOCUMENTOVENTACAB_MEDIOPAGO_MENSUALES";
                        //cambiar
                        sql_comando.Parameters.Add("@Desde", SqlDbType.VarChar, 8).Value = objEntidadBE.DesdeInt;
                        sql_comando.Parameters.Add("@Hasta", SqlDbType.VarChar, 8).Value = objEntidadBE.HastaInt;
                        //sql_comando.Parameters.Add("@Ruta", SqlDbType.Int).Value = objEntidadBE.Ruta;
        ...
        public DataTable F_DOCUMENTOVENTACAB_INGRESO_MENSUALES(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "PA_DOCUMENTOVENTACAB_INGRESO_MENSUALES";
                        //cambiar
                        sql_comando.Parameters.Add("@Desde", SqlDbType.VarChar, 8).Value = objEntidadBE.DesdeInt;
                        sql_comando.Parameters.Add("@Hasta", SqlDbType.VarChar, 8).Value = objEntidadBE.HastaInt;
                        //sql_comando.Parameters.Add("@Ruta", SqlDbType.Int).Value = objEntidadBE.Ruta;
        ...
        public DataTable F_DOCUMENTOVENTACAB_INGRESOVENCIDO_MENSUALES(DocumentoVentaCabCE objEntidadBE)
        {
            DataTable dta_consulta = null;
            try
            {
        ...
        public DocumentoVentaCabCE F_EdicionComisionTarjeta(DocumentoVentaCabCE objEntidadBE)
        {
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_EdicionComisionTarjeta";
