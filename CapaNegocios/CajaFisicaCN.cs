...
namespace CapaNegocios
{
    public class CajaFisicaCN
    {
        ...
        public DataTable F_dtCajaFisica_Listar(int CodEstado)
        {
            try
            {
                return obj.F_CajaFisica_Listar(CodEstado);
            }
            catch (Exception ex)
            {
        ...
        public List<CajaFisicaCE> F_CajaFisica_Listar(int CodEstado, int Opcional)
        {
            try
            {
                DataTable dtDatos = obj.F_CajaFisica_Listar(CodEstado);
        ...
        public DataTable F_dtCajaFisica_Listar_william(int CodEstado, int CodAlmacen, int CodEmpresa)
        {
            try
            {
                return obj.F_dtCajaFisica_Listar_william(CodEstado, CodAlmacen, CodEmpresa);
            }
            catch (Exception ex)
            {
