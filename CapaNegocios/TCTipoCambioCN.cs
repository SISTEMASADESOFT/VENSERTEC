   ...
   public class TCTipoCambioCN
    {
       ...
       public TCTipoCambioCE F_TCTipoCambio_Insert_William(TCTipoCambioCE objEntidadBE)
       {

           try
           {

               return obj.F_TCTipoCambio_Insert_William(objEntidadBE);
       ...
       public TCTipoCambioCE F_TCTipoCambio_Update_William(TCTipoCambioCE objEntidadBE)
       {

           try
           {

               return obj.F_TCTipoCambio_Update_William(objEntidadBE);
       ...
       public DataTable F_TCTipoCambio_Select_William(TCTipoCambioCE objEntidadBE)
       {

           try
           {

               return obj.F_TCTipoCambio_Select_William(objEntidadBE);
       ...
       public DataTable F_TCTipoCambio_Listar_William(TCTipoCambioCE objEntidadBE)
       {

           try
           {

               return obj.F_TCTipoCambio_Listar_William(objEntidadBE);
