...
public class DocumentoVentaCabCE
{
    ...
    public int Codtipodoctemporal { get; set; }
    ...
    public string NroRuctrans { get; set; }

    public int CodDepartamentoGuia { get; set; }

    public int CodDistritoGuia { get; set; }

    public int CodProvinciaGuia { get; set; }
    ...
    public int CodtipoCobranza { get; set; }
